...
> **STATUS:** ✅ Batch 1 (T3/T4/T5/T11), ✅ Batch 2 (T9/T10), ✅ Batch 3 (T12/T13/T17/T18), ✅ Batch 4 (T6/T7/T8/T14, Electron-saja), ✅ Batch 5 (T15/T16) & ✅ **Batch 6 (T2 — Kenaikan/Mutasi skema Sekolah)** SELESAI (verify `_run_vite.cmd` exit 0, BELUM commit/deploy oleh kyai). Plus fix: tombol Migrate gabung nama-sama bersinyal. ⏳ Lanjut: Batch 7 (login Electron T19/T20) → Batch 8 (re-audit + bump vc≥100 + ship). Keputusan kyai: Batch 4 Bisyaroh/Syahriyah = Electron saja (web/Android pakai Pengaturan Keuangan gabungan). Batch 6: schema sekolah = 1 tanggal naik/kelas + kelulusan di kelas akhir; cakupan semua step (default schema + Pengaturan + Form Proses Naik + Riwayat + PDF kartu).
