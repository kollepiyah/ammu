...
import { u as ze } from './useToast-BjwjYk11.js'
import { u as Qe } from './useConfirm-DjSfx6QZ.js'
import { u as Je } from './useLembaga-8ypq4SFU.js'
import { uploadBase64 as Oe } from './storage-BBNevPRC.js'
import { c as ee } from './createLucideIcon-Cs-CWcWM.js'
const Ee = {
    class:
      'rounded-xl bg-[#F0FFFF] dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm p-4'
  },
  qe = { key: 0, class: 'mb-3' },
  Ge = { key: 0, class: 'text-base font-bold text-slate-900 dark:text-slate-100' },
  We = { key: 1, class: 'text-sm text-slate-600 dark:text-slate-400' },
  Xe = { key: 1, class: 'mt-4 pt-3 border-t border-slate-200 dark:border-slate-700' },
  U = {
    __name: 'UiCard',
    ...
    setup(f) {
      return (L, C) => (
        r(),
        i('div', Ee, [
          f.title || f.subtitle || L.$slots.header
            ? (r(),
              i('div', qe, [
                Y(L.$slots, 'header', {}, () => [
                  f.title ? (r(), i('h2', Ge, v(f.title), 1)) : K('', !0),
                  f.subtitle ? (r(), i('p', We, v(f.subtitle), 1)) : K('', !0)
                ])
              ]))
            : K('', !0),
          Y(L.$slots, 'default'),
          L.$slots.footer ? (r(), i('div', Xe, [Y(L.$slots, 'footer')])) : K('', !0)
        ])
      )
    }
  },
  Ye = { class: 'block' },
  Ze = { key: 0, class: 'block text-xs font-semibold mb-1 text-slate-700 dark:text-slate-300' },
  ea = { key: 0, class: 'text-rose-500' },
  aa = ['value', 'type', 'placeholder', 'disabled'],
  ta = { key: 1, class: 'mt-1 text-xs text-rose-600' },
  la = { key: 2, class: 'mt-1 text-xs text-slate-500' },
  c = {
    __name: 'UiInput',
    props: {
    ...
    setup(f) {
      return (L, C) => (
        ...
        i('label', Ye, [
          f.label
            ? (r(),
              i('span', Ze, [u(v(f.label), 1), f.required ? (r(), i('span', ea, '*')) : K('', !0)]))
            : K('', !0),
          a(
            'input',
            {
              ...
              onInput: C[0] || (C[0] = (S) => L.$emit('update:modelValue', S.target.value))
            },
            null,
            42,
            aa
  ...
  z = {
    ...
    setup(f) {
      const L = {
        ...
        C = { sm: 'px-3 py-1.5 text-xs', md: 'px-4 py-2 text-sm', lg: 'px-5 py-2.5 text-base' }
      return (S, Q) => (
        r(),
        i(
          'button',
          {
            ...
            class: Z([
              ...
              [L[f.variant], C[f.size]]
            ])
          },
          [f.loading ? (r(), i('span', oa)) : K('', !0), Y(S.$slots, 'default')],
          10,
          sa
        )
      )
 ...
 */ const X = ee('Trash2Icon', [
  ...
  na = { class: 'p-4 max-w-5xl mx-auto pb-32' },
  da = { class: 'mb-4 flex items-center justify-between gap-3' },
  ua = { class: 'flex items-center gap-2' },
  pa = { class: 'text-xs text-slate-500' },
  ma = {
    key: 0,
    class: 'ml-1 px-1.5 py-0.5 rounded bg-amber-100 text-amber-700 text-[10px] font-bold'
  },
  ba = { class: 'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2 mb-4' },
  xa = ['onClick'],
  ga = { class: 'text-[11px] md:text-xs font-black leading-tight drop-shadow-sm' },
  fa = { class: 'grid md:grid-cols-2 gap-3' },
  ca = { class: 'grid gap-3' },
  va = { class: 'mt-4 p-3 bg-slate-50 border border-slate-200 rounded-lg text-center' },
  ka = { class: 'text-xs uppercase tracking-widest font-black text-slate-700' },
  ha = { class: 'text-lg font-black text-slate-800' },
  ya = { key: 0, class: 'text-xs text-slate-600' },
  wa = { key: 1, class: 'text-xs text-slate-600' },
  Ka = { class: 'grid md:grid-cols-2 gap-4' },
  Sa = { class: 'border-2 border-dashed border-emerald-300 p-4 rounded-2xl bg-emerald-50' },
  Ia = { class: 'flex items-center gap-3 mb-2' },
  Va = ['src'],
  Pa = ['disabled'],
  Ta = { class: 'border-2 border-dashed border-amber-300 p-4 rounded-2xl bg-amber-50' },
  Ua = { class: 'flex items-center gap-3 mb-2' },
  Aa = ['src'],
  La = ['disabled'],
  Ca = { class: 'border-2 border-dashed border-emerald-300 p-4 rounded-2xl bg-emerald-50' },
  Ma = { class: 'flex items-center gap-3 mb-2' },
  Da = ['src'],
  _a = ['disabled'],
  Ba = { class: 'border-2 border-dashed border-slate-300 p-4 rounded-2xl bg-slate-50' },
  ja = { class: 'flex items-center gap-3 mb-2' },
  Na = {
    class: 'w-16 h-16 rounded bg-white border flex items-center justify-center overflow-hidden'
  },
  $a = ['src'],
  Fa = ['disabled'],
  Ra = { class: 'border-2 border-dashed border-teal-300 p-4 rounded-2xl bg-teal-50' },
  Ha = { class: 'flex items-center gap-3 mb-2' },
  za = {
    class: 'w-16 h-16 rounded bg-white border flex items-center justify-center overflow-hidden'
  },
  Qa = ['src'],
  Ja = ['disabled'],
  Oa = { class: 'border-2 border-dashed border-purple-300 p-4 rounded-2xl bg-purple-50' },
  Ea = { class: 'flex items-center gap-3 mb-2' },
  qa = {
    class: 'w-16 h-16 rounded bg-white border flex items-center justify-center overflow-hidden'
  },
  Ga = ['src'],
  Wa = ['disabled'],
  Xa = { class: 'flex items-center gap-4' },
  Ya = {
    class: 'bg-teal-50 border border-teal-200 px-3 py-1.5 rounded-lg text-center min-w-[80px]'
  },
  Za = { class: 'text-xl font-black text-teal-800' },
  et = { class: 'mt-3 p-3 bg-emerald-50 border border-emerald-200 rounded-lg' },
  at = { class: 'text-lg font-black text-emerald-800' },
  tt = { class: 'mb-3 flex justify-between items-center' },
  lt = { class: 'text-xs text-slate-500' },
  st = {
    key: 0,
    class:
      'text-center text-xs text-slate-400 italic py-6 border-2 border-dashed border-slate-200 rounded-lg'
  },
  ot = { key: 1, class: 'space-y-2' },
  rt = { class: 'grid md:grid-cols-6 gap-2' },
  it = ['onUpdate:modelValue'],
  nt = ['onUpdate:modelValue'],
  dt = ['onUpdate:modelValue'],
  ut = { class: 'flex items-end' },
  pt = ['onClick'],
  mt = { class: 'grid md:grid-cols-2 gap-3' },
  bt = ['value'],
  xt = { class: 'grid md:grid-cols-3 gap-2' },
  gt = { class: 'flex items-end' },
  ft = { class: 'grid md:grid-cols-3 gap-4' },
  ...
  Ut = { key: 1, class: 'space-y-3' },
  At = {
    class:
      'cursor-pointer p-3 font-black text-sm text-emerald-800 flex justify-between items-center'
  },
  Lt = { class: 'p-3 border-t border-emerald-200 grid gap-2' },
  Ct = ['value', 'onChange'],
  Mt = { class: 'grid md:grid-cols-2 gap-2' },
  Dt = { class: 'flex items-center gap-2 cursor-pointer p-2 hover:bg-slate-50 rounded' },
  _t = { class: 'flex items-center gap-2 cursor-pointer p-2 hover:bg-slate-50 rounded' },
  Bt = { class: 'flex items-center gap-2 cursor-pointer p-2 hover:bg-slate-50 rounded' },
  jt = { class: 'flex items-center gap-2 cursor-pointer p-2 hover:bg-slate-50 rounded' },
  ...
  Ft = { class: 'p-3 bg-purple-50 border border-purple-200 rounded-lg mt-3' },
  Rt = { class: 'flex gap-3 flex-wrap' },
  Ht = { class: 'flex items-center gap-2 cursor-pointer text-sm' },
  zt = { class: 'flex items-center gap-2 cursor-pointer text-sm' },
  Qt = { class: 'grid md:grid-cols-3 gap-4' },
  Jt = { class: 'p-3 bg-amber-50 border border-amber-200 rounded-xl' },
  Ot = { class: 'grid grid-cols-3 gap-2' },
  Et = { class: 'p-3 bg-indigo-50 border border-indigo-200 rounded-xl' },
  qt = { class: 'grid grid-cols-3 gap-2' },
  Gt = { class: 'p-3 bg-teal-50 border border-teal-200 rounded-xl' },
  Wt = { class: 'grid grid-cols-3 gap-2' },
  Xt = { class: 'grid md:grid-cols-2 gap-3' },
  Yt = { class: 'md:col-span-2' },
  Zt = {
    class:
      'md:col-span-2 flex items-center gap-3 p-3 bg-slate-50 rounded-lg cursor-pointer border border-slate-200'
  },
  el = { class: 'space-y-2 mb-3' },
  al = ['onUpdate:modelValue'],
  tl = ['onClick'],
  ll = { key: 0, class: 'text-xs text-slate-400 italic text-center py-2' },
  sl = { class: 'flex gap-2' },
  ol = { class: 'mt-5 border-t border-violet-200 pt-4' },
  rl = { class: 'space-y-3' },
  il = { class: 'flex items-center justify-between mb-2' },
  nl = { class: 'text-xs font-black text-violet-800 uppercase' },
  dl = ['onClick'],
  ul = { class: 'flex flex-wrap gap-1.5' },
  pl = ['onUpdate:modelValue'],
  ml = ['onClick'],
  bl = ['onClick'],
  xl = { class: 'flex gap-2 mt-3' },
  gl = { class: 'space-y-3' },
  fl = {
    class:
  ...
  vl = { class: 'grid grid-cols-2 gap-3' },
  kl = { class: 'space-y-3' },
  hl = ['value'],
  yl = { key: 0, class: 'bg-purple-50 border border-purple-200 rounded-xl p-4 space-y-3' },
  wl = { class: 'text-xs font-black text-purple-900 uppercase' },
  Kl = ['value'],
  Sl = { key: 0, class: 'space-y-2' },
  Il = { class: 'flex flex-wrap gap-2' },
  Vl = ['onClick'],
  Pl = { class: 'flex gap-2' },
  Tl = { class: 'space-y-2' },
  Ul = { class: 'grid grid-cols-3 gap-2 mb-2' },
  Al = ['onUpdate:modelValue'],
  Ll = ['onUpdate:modelValue'],
  Cl = ['onClick'],
  Ml = { class: 'space-y-1' },
  ...
  Bl = ['onClick'],
  jl = ['onClick'],
  Nl = { key: 1, class: 'space-y-2' },
  $l = { class: 'flex items-center justify-between mb-1' },
  Fl = ['onUpdate:modelValue'],
  Rl = ['onClick'],
  Hl = { class: 'grid grid-cols-1 md:grid-cols-3 gap-1 mt-1' },
  zl = ['onUpdate:modelValue'],
  Ql = ['onUpdate:modelValue'],
  Jl = ['onClick'],
  Ol = ['onClick'],
  El = { key: 2, class: 'space-y-2' },
  ql = { class: 'flex items-center justify-between gap-2' },
  Gl = ['onUpdate:modelValue'],
  Wl = ['onClick'],
  Xl = { class: 'space-y-1' },
  Yl = { class: 'flex flex-wrap gap-1' },
  Zl = ['onUpdate:modelValue'],
  es = ['onClick'],
  as = ['onClick'],
  ts = { class: 'space-y-1' },
  ls = ['onUpdate:modelValue'],
  ss = ['onUpdate:modelValue'],
  os = ['onClick'],
  rs = ['onClick'],
  is = {
    class:
  ...
  xs = {
    ...
    setup(f) {
      ...
      const re = Fe()
      ;(je(async () => {
        ;(await C.load(), C.subscribe(), oe())
        const s = re.query.section
        s && typeof s == 'string' && (w.value = s)
        const e = re.query.lembaga
      ...
      function ve(s, e = 0) {
        const t = new Date(s.getTime() + e * 864e5),
          m = Math.floor(t.getTime() / 864e5) + 2440588 - 1948440 + 10632,
          b = Math.floor((m - 1) / 10631),
          n = m - 10631 * b + 354,
          A =
          ...
          g =
            n -
            Math.floor((30 - A) / 15) * Math.floor((17719 * A) / 50) -
            Math.floor(A / 16) * Math.floor((15238 * A) / 43) +
            29,
          P = Math.floor((24 * g) / 709),
          y = g - Math.floor((709 * P) / 24),
          _e = 30 * b + A - 30
        return { day: y, month: P, year: _e }
      }
      const ke = le(() => {
        try {
          const s = ve(new Date(), Number(l.value.kalibrasiHijri || 0))
          return `${s.day} ${ce[s.month - 1] || '?'} ${s.year} H`
        } catch {
          return '—'
        }
      })
      ...
      const de = ['tpq', 'tpq pagi', 'tpq sore', 'pra ptpt', 'ptpt', 'ppph', 'p3h'],
        we = [
          'non-lembaga',
          'non_lembaga',
          'non lembaga',
        ...
        ue = le(() =>
          ae.value
            .filter((s) => {
              const e = F(s),
                t = ne(s)
              return we.includes(t) || Ke.test(e)
                ? !1
                : !!(
                    [
                      'formal',
                    ...
                    (!t && !de.includes(e.toLowerCase()))
                  )
            })
            .map((s) => ({ id: s.id || F(s), nama: F(s) }))
        ),
        pe = le(() =>
          ae.value
            .filter((s) => {
              const e = F(s).toLowerCase(),
                t = ne(s)
              return t === 'qiraati' || t === 'tahfizh' || de.includes(e)
            })
            .map((s) => ({ id: s.id || F(s), nama: F(s) }))
        )
      function R(s) {
      ...
      const M = D('')
      async function $(s, e, t = 'app_logos') {
        var m
        const p = (m = s.target.files) == null ? void 0 : m[0]
        if (p) {
          if (p.size > 5 * 1024 * 1024) {
            S.error('File terlalu besar (maks 5MB)')
            return
          }
          M.value = e
          try {
            ...
            ;((b.onload = async () => {
              try {
                const n = await Oe(`${t}/${Date.now()}_${p.name}`, b.result, p.type)
                ;(Se(l.value, e, n), S.success('Upload berhasil'), (B.value = !0))
              } catch (n) {
                S.error('Upload gagal: ' + (n.message || n))
              } finally {
                M.value = ''
              }
            }),
              (b.onerror = () => {
                ;(S.error('Gagal baca file'), (M.value = ''))
              }),
              b.readAsDataURL(p))
          } catch (b) {
            ;(S.error('Error: ' + (b.message || b)), (M.value = ''))
          }
          s.target.value = ''
        }
      }
      function Se(s, e, t) {
        const p = e.split('.')
        let m = s
        for (let b = 0; b < p.length - 1; b++) (m[p[b]] || (m[p[b]] = {}), (m = m[p[b]]))
        m[p[p.length - 1]] = t
      }
      async function Ie() {
        if (!N.value || N.value.length < 4) {
          S.error('Password minimal 4 karakter')
          return
        }
        if (N.value !== O.value) {
          S.error('Konfirmasi password tidak cocok')
          return
        }
        ;(await Q({
          ...
          ((l.value.adminPassword = N.value),
          (N.value = ''),
          (O.value = ''),
          S.info('Password siap disimpan — klik Simpan untuk apply'),
          (B.value = !0))
      }
      async function Ve() {
        ;(B.value &&
      ...
      function be() {
        ...
        const p = e
          ...
          .replace(/\s+/g, '_')
          .replace(/[^a-z0-9_]/g, '')
        if (t.fieldsNilai.find((m) => m.id === p)) {
          S.warning('Field sudah ada')
          return
        }
        ;(t.fieldsNilai.push({ id: p, label: e }), (E.value = ''))
      }
      function Te(s) {
        const e = h.value,
          t = l.value.raporSchemas[e]
        t != null && t.fieldsNilai && t.fieldsNilai.splice(s, 1)
      }
      function Ue(s) {
        Array.isArray(s.khotamList) || (s.khotamList = [])
        const e = ['I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI', 'XII'],
          t = s.khotamList.length,
          p = t < e.length ? `Khotam ${e[t]}` : `Khotam ${t + 1}`,
          m = `kh_${e[t] || t + 1}`,
          b = (s.khotamList.length > 0 && s.khotamList[s.khotamList.length - 1].multiplier) || 2
        s.khotamList.push({ id: m, labelKhotam: p, multiplier: b })
      }
      function Ae() {
        const s = h.value,
      ...
      function xe() {
        ...
        if (s) {
          if (l.value.rekapSchemaDiniyah.includes(s)) {
            ;(S.warning('Mata pelajaran sudah ada'), (H.value = ''))
            return
          }
          ;(l.value.rekapSchemaDiniyah.push(s), (H.value = ''))
        }
      }
      function Me() {
        const s = h.value
        ...
        ;(e === 'pra ptpt' || e === 'ptpt' || e === 'ppph' || e === 'p3h'
              ...
              levels: [
                ...
                },
                {
                  ...
                  khotamList: [
                    ...
                    { id: 'kh_II', labelKhotam: 'Khotam II', multiplier: 3 },
                    { id: 'kh_III', labelKhotam: 'Khotam III', multiplier: 3 },
                    { id: 'kh_IV', labelKhotam: 'Khotam IV', multiplier: 3 },
                    { id: 'kh_V', labelKhotam: 'Khotam V', multiplier: 3 },
                    { id: 'kh_VI', labelKhotam: 'Khotam VI', multiplier: 3 },
                    { id: 'kh_VII', labelKhotam: 'Khotam VII', multiplier: 3 },
                    { id: 'kh_VIII', labelKhotam: 'Khotam VIII', multiplier: 3 },
                    { id: 'kh_IX', labelKhotam: 'Khotam IX', multiplier: 3 },
                    { id: 'kh_X', labelKhotam: 'Khotam X', multiplier: 3 },
                    { id: 'kh_XI', labelKhotam: 'Khotam XI', multiplier: 3 }
                  ]
                }
              ]
            })
          ...
          (B.value = !0),
          S.success(`Schema ${s} di-reset ke template default. Klik Simpan untuk apply.`))
      }
      const w = D('identitas'),
        De = [
          {
        ...
        i('div', na, [
          a('header', da, [
            a('div', ua, [
              d(
                z,
                { variant: 'ghost', size: 'sm', onClick: Ve },
                { default: k(() => [d(_(ra), { class: 'w-4 h-4' })]), _: 1 }
              ),
              a('div', null, [
                e[64] || (e[64] = a('h1', { class: 'text-xl font-bold' }, 'Pengaturan Web', -1)),
                a('p', pa, [
                  e[63] || (e[63] = u(' Setting global aplikasi (match legacy) ', -1)),
                  B.value ? (r(), i('span', ma, 'UNSAVED')) : K('', !0)
                ])
              ])
            ])
          ]),
                ...
                a(
                  ...
                  [
                    a(
                      'i',
                      {
                        class: Z(['fas', t.icon, 'text-base md:text-lg drop-shadow flex-shrink-0'])
                      },
                      null,
                      2
                    ),
            ...
            d(
              ...
              },
              {
                default: k(() => [
                  ...
                  a('div', va, [
                    a('p', ka, v(l.value.kopLine1 || '— Baris 1 —'), 1),
                    a('p', ha, v(l.value.kopLine2 || '— Baris 2 —'), 1),
                    l.value.kopLine3 ? (r(), i('p', ya, v(l.value.kopLine3), 1)) : K('', !0),
                    l.value.kopLine4 ? (r(), i('p', wa, v(l.value.kopLine4), 1)) : K('', !0)
                  ])
                ]),
                _: 1
              },
                      ...
                      a('div', Ia, [
                        ...
                        a(
                          'input',
                          {
                            type: 'file',
                            accept: 'image/*',
                            onChange: e[13] || (e[13] = (t) => $(t, 'logoUrl', 'app_logos')),
                            disabled: M.value === 'logoUrl',
                      ...
                      a('div', Ua, [
                        ...
                        a(
                          'input',
                          {
                            type: 'file',
                            accept: 'image/*',
                            onChange: e[14] || (e[14] = (t) => $(t, 'logoKop', 'app_logos')),
                            disabled: M.value === 'logoKop',
                            class: 'text-xs flex-1'
                          },
                          null,
                          40,
                      ...
                      a('div', Ma, [
                        ...
                        a(
                          'input',
                          {
                            type: 'file',
                            accept: 'image/*',
                            onChange: e[15] || (e[15] = (t) => $(t, 'logoQiraati', 'app_logos')),
                            disabled: M.value === 'logoQiraati',
                            class: 'text-xs flex-1'
                          },
                          null,
                          40,
                      ...
                      a('div', ja, [
                        a('div', Na, [
                          l.value.bgImage
                            ...
                            : (r(), te(_(se), { key: 1, class: 'w-6 h-6 text-slate-400' }))
                        ]),
                        a(
                          'input',
                          {
                            type: 'file',
                            accept: 'image/*',
                            onChange: e[16] || (e[16] = (t) => $(t, 'bgImage', 'app_bg')),
                            disabled: M.value === 'bgImage',
                            class: 'text-xs flex-1'
                          },
                          null,
                          40,
                      ...
                      l.value.bgImage
                        ? (r(),
                          i(
                            ...
                            [
                              d(_(X), { class: 'w-3 h-3 inline' }),
                              e[71] || (e[71] = u(' Hapus BG ', -1))
                            ]
                          ))
                        : K('', !0)
                    ]),
                      ...
                      a('div', Ha, [
                        a('div', za, [
                          l.value.bgRaporTPQ
                            ...
                            : (r(), te(_(se), { key: 1, class: 'w-6 h-6 text-teal-400' }))
                        ]),
                        a(
                          'input',
                          {
                            type: 'file',
                            accept: 'image/*',
                            onChange: e[18] || (e[18] = (t) => $(t, 'bgRaporTPQ', 'app_bg')),
                            disabled: M.value === 'bgRaporTPQ',
                            class: 'text-xs flex-1'
                          },
                          null,
                          40,
                      ...
                      a('div', Ea, [
                        a('div', qa, [
                          l.value.bgRaporDiniyah
                            ...
                            : (r(), te(_(se), { key: 1, class: 'w-6 h-6 text-purple-400' }))
                        ]),
                        a(
                          'input',
                          {
                            type: 'file',
                            accept: 'image/*',
                            onChange: e[20] || (e[20] = (t) => $(t, 'bgRaporDiniyah', 'app_bg')),
                            disabled: M.value === 'bgRaporDiniyah',
                            class: 'text-xs flex-1'
                          },
                          null,
                          40,
          ...
          o(
            d(
              ...
              },
              {
                default: k(() => [
                  a('div', tt, [
                    a('p', lt, v(l.value.masterKegiatan.length) + ' kegiatan terdaftar', 1),
                    d(
                      z,
                      { size: 'sm', variant: 'primary', onClick: he },
                      {
                        default: k(() => [
                          d(_(ia), { class: 'w-3.5 h-3.5' }),
                          e[82] || (e[82] = u('Tambah ', -1))
                        ]),
                        _: 1
                      }
                    )
                                ...
                                [
                                  a('div', rt, [
                                    d(
                                      ...
                                      {
                                        modelValue: t.nama,
                                        'onUpdate:modelValue': (m) => (t.nama = m),
                                        label: 'Nama Kegiatan',
                                        class: 'md:col-span-2'
                                      },
                                      null,
                                    ...
                                    a('div', null, [
                                      ...
                                      o(
                                        a(
                                          'input',
                                          {
                                            'onUpdate:modelValue': (m) => (t.jam_mulai = m),
                                            type: 'time',
                                            class:
                                    ...
                                    a('div', null, [
                                      ...
                                      o(
                                        a(
                                          'input',
                                          {
                                            'onUpdate:modelValue': (m) => (t.jam_terlambat = m),
                                            type: 'time',
                                            class:
                                              'w-full px-2 py-1.5 text-xs border border-slate-300 rounded'
                                          },
                                    ...
                                    a('div', null, [
                                      ...
                                      o(
                                        a(
                                          'input',
                                          {
                                            'onUpdate:modelValue': (m) => (t.skor = m),
                                            type: 'number',
                                            min: '0',
                                            max: '100',
                                            class:
                    ...
                    [
                      ...
                      a('div', xt, [
                        d(
                          ...
                          {
                            modelValue: N.value,
                            'onUpdate:modelValue': e[24] || (e[24] = (t) => (N.value = t)),
                            type: 'password',
                            label: 'Password Baru',
                        ...
                        d(
                          ...
                          {
                            modelValue: O.value,
                            'onUpdate:modelValue': e[25] || (e[25] = (t) => (O.value = t)),
                            type: 'password',
                            label: 'Konfirmasi',
                            autocomplete: 'new-password'
                          },
                        ...
                        a('div', gt, [
                          d(
                            z,
                            { size: 'sm', variant: 'primary', type: 'submit', disabled: !N.value },
                            {
                              default: k(() => [...(e[87] || (e[87] = [u(' Apply ', -1)]))]),
                              _: 1
                            },
                            8,
                            ['disabled']
                                ...
                                [
                                  ...
                                  a('div', Kt, [
                                    d(
                                      c,
                                      {
                                        'model-value': R(t.nama).kopLine1,
                                        'onUpdate:modelValue': (b) =>
                                          (l.value.submenuFormal[t.nama].kopLine1 = b),
                                    ...
                                    d(
                                      c,
                                      {
                                        'model-value': R(t.nama).kopLine2,
                                        'onUpdate:modelValue': (b) =>
                                          (l.value.submenuFormal[t.nama].kopLine2 = b),
                                    ...
                                    d(
                                      c,
                                      {
                                        'model-value': R(t.nama).kopLine3,
                                        'onUpdate:modelValue': (b) =>
                                          (l.value.submenuFormal[t.nama].kopLine3 = b),
                                    ...
                                    d(
                                      c,
                                      {
                                        'model-value': R(t.nama).kopLine4,
                                        'onUpdate:modelValue': (b) =>
                                          (l.value.submenuFormal[t.nama].kopLine4 = b),
                                    ...
                                    a('div', St, [
                                      a(
                                        ...
                                        {
                                          src:
                                            ((p = l.value.submenuFormal[t.nama]) == null
                                              ? void 0
                                              : p.logoSekolah) || '/logo.png',
                                          class:
                                    ...
                                    a('div', null, [
                                      ...
                                      a(
                                        ...
                                        {
                                          value:
                                            ((m = l.value.submenuFormal[t.nama]) == null
                                              ? void 0
                                              : m.tarifSPP) || 0,
                                          onInput: (b) => {
                                            ;(R(t.nama),
          ...
          o(
            d(
              ...
              },
              {
                default: k(() => [
                  pe.value.length === 0
                    ? (r(), i('div', Tt, ' Belum ada lembaga Qiraati/PTPT terdaftar. '))
                    : (r(),
                      i('div', Ut, [
                        (r(!0),
                        i(
                                ...
                                [
                                  ...
                                  a('div', Lt, [
                                    d(
                                      c,
                                      {
                                        'model-value': me(t.nama).targetKelas,
                                        'onUpdate:modelValue': (m) =>
                                          (l.value.submenuQiraati[t.nama].targetKelas = m),
                                        label:
                                    ...
                                    a('div', null, [
                                      ...
                                      a(
                                        ...
                                        {
                                          value:
                                            ((p = l.value.submenuQiraati[t.nama]) == null
                                              ? void 0
                                              : p.formatRekap) || 'standard',
                                          onChange: (m) => {
                                            ;(me(t.nama),
                  ...
                  a('div', Mt, [
                    a('label', Dt, [
                      o(
                        ...
                        [[j, l.value.fiturBeranda]]
                      ),
                      e[102] || (e[102] = u(' Beranda (Mading + Quick Action) ', -1))
                    ]),
                    a('label', _t, [
                      o(
                        a(
                        ...
                        [[j, l.value.fiturKalender]]
                      ),
                      e[103] || (e[103] = u(' Kalender Pendidikan ', -1))
                    ]),
                    a('label', Bt, [
                      o(
                        a(
                        ...
                        [[j, l.value.fiturKritikSaran]]
                      ),
                      e[104] || (e[104] = u(' Kritik & Saran ', -1))
                    ]),
                    a('label', jt, [
                      o(
                        a(
                        ...
                        [[j, l.value.fiturNotifikasi]]
                      ),
                      e[105] || (e[105] = u(' Notifikasi FCM ', -1))
                    ]),
                    a('label', Nt, [
                      o(
                        a(
                        ...
                        [[j, l.value.autoNotifPostingan]]
                      ),
                      e[106] || (e[106] = u(' Auto-Notif setiap Postingan ', -1))
                    ]),
                    a('label', $t, [
                      o(
                        a(
                        ...
                        [[j, l.value.softDelete]]
                      ),
                      e[107] || (e[107] = u(' Soft Delete (recoverable) ', -1))
                    ])
                  ]),
                  a('div', Ft, [
                    e[110] ||
                        ...
                        e[108] ||
                          (e[108] = a(
                            ...
                            [
                              ...
                              u(' — server.url ke Firebase Hosting')
                            ],
                            -1
                          ))
                      ]),
                    ...
                    a('div', Jt, [
                      e[114] ||
                        (e[114] = a(
                          ...
                          [a('i', { class: 'fas fa-sun mr-1' }), u('SHIFT PAGI')],
                          -1
                        )),
                      a('div', Ot, [
                        a('div', null, [
                    ...
                    a('div', Et, [
                      e[118] ||
                        (e[118] = a(
                          ...
                          [a('i', { class: 'fas fa-moon mr-1' }), u('SHIFT SORE')],
                          -1
                        )),
                      a('div', qt, [
                        a('div', null, [
                    ...
                    a('div', Gt, [
                      e[122] ||
                        (e[122] = a(
                          ...
                          [a('i', { class: 'fas fa-school mr-1' }), u('SHIFT SEKOLAH')],
                          -1
                        )),
                      a('div', Wt, [
                        a('div', null, [
                ...
                default: k(() => [
                  a('div', el, [
                            ...
                            [
                              o(
                                a(
                                  ...
                                  {
                                    'onUpdate:modelValue': (m) =>
                                      (l.value.rekapSchemaDiniyah[p] = m),
                                    type: 'text',
                                    class:
                                ...
                                [[x, l.value.rekapSchemaDiniyah[p]]]
                              ),
                              a(
                                'button',
                                {
                                  onClick: (m) => l.value.rekapSchemaDiniyah.splice(p, 1),
                                  class:
                    ...
                    l.value.rekapSchemaDiniyah.length === 0
                      ? (r(), i('p', ll, 'Belum ada mata pelajaran. Tambah di bawah.'))
                      : K('', !0)
                  ]),
                  a('div', sl, [
                    o(
                      a(
                        'input',
                        {
                          'onUpdate:modelValue': e[54] || (e[54] = (t) => (H.value = t)),
                          onKeyup: fe(xe, ['enter']),
                          type: 'text',
                  ...
                  e[138] ||
                    (e[138] = a(
                      ...
                      [
                        ...
                        u('Mata pelajaran '),
                        a('b', null, 'default'),
                        u(' (semua kelas). Untuk override per-kelas, edit di bawah. ')
                      ],
                      -1
                    )),
                  a('div', ol, [
                      ...
                      i(
                        ...
                        V(
                          ...
                          (t, p) => (
                            ...
                            i(
                              'div',
                              { key: p, class: 'bg-white border border-violet-200 rounded-xl p-3' },
                              [
                                a('div', il, [
                                  a('p', nl, '📚 Kelas ' + v(p), 1),
                                  a(
                                    'button',
                                    {
                                      onClick: (m) => delete l.value.rekapSchemaDiniyahPerKelas[p],
                                      class:
                                ...
                                a('div', ul, [
                                        ...
                                        i(
                                          ...
                                          [
                                            o(
                                              a(
                                                'input',
                                                {
                                                  'onUpdate:modelValue': (n) =>
                                                    (l.value.rekapSchemaDiniyahPerKelas[p][b] = n),
                                                  class:
                                              ...
                                              [[x, l.value.rekapSchemaDiniyahPerKelas[p][b]]]
                                            ),
                                            a(
                                              'button',
                                              {
                                                onClick: (n) =>
                                                  l.value.rekapSchemaDiniyahPerKelas[p].splice(
                                                    b,
                                                    1
                                                  ),
                                  ...
                                  a(
                                    ...
                                    {
                                      onClick: (m) =>
                                        l.value.rekapSchemaDiniyahPerKelas[p].push('Mapel Baru'),
                                      class:
                    ...
                    a('div', xl, [
                      o(
                        a(
                          'input',
                          {
                            'onUpdate:modelValue': e[55] || (e[55] = (t) => (G.value = t)),
                            type: 'text',
                  ...
                  a('div', gl, [
                    ...
                    a('label', cl, [
                      o(
                        ...
                        [[j, l.value.postinganAutoApprove]]
                      ),
                      e[140] ||
                        (e[140] = a(
                          'div',
          ...
          o(
                  ...
                  return [
                    a('div', kl, [
                      ...
                      h.value
                        ? (r(),
                          i('div', yl, [
                            a('p', wl, 'Schema untuk: ' + v(h.value), 1),
                            a(
                              'div',
                              {
                                class:
                                ...
                                e[148] ||
                                  (e[148] = a(
                                    ...
                                    [
                                      ...
                                      u(' → matrix Level × Khotam (½ Juz, 1 Juz, ..., 3 Juz) '),
                                      a('br'),
                                      ...
                                      u(' → mata pelajaran per kelas + KKM '),
                                      a('br'),
                                      a('br'),
                            ...
                            a('div', null, [
                              ...
                              a(
                                ...
                                {
                                  value: q(),
                                  onChange: e[61] || (e[61] = (n) => Pe(n.target.value)),
                                  class:
                                ...
                                ? (r(),
                                  i('div', Nl, [
                                    ...
                                    i(
                                      ...
                                      null,
                                      V(
                                        ((m = l.value.raporSchemas[h.value]) == null
                                          ? void 0
                                          : m.jenjang) || [],
                                        (n, A) => (
                                          r(),
            ...
            [[T, w.value === 'raporSchema']]
          ),
          a('div', is, [
            d(
              z,
              { variant: 'secondary', size: 'sm', onClick: s.resetForm },
              {
                default: k(() => [
                  ...(e[169] ||
                    (e[169] = [a('i', { class: 'fas fa-undo mr-1' }, null, -1), u('Reset ', -1)]))
                ]),
                _: 1
              },
              8,
            ...
            d(
              z,
              { variant: 'primary', size: 'sm', onClick: s.simpanSemua, loading: s.saving },
              {
                default: k(() => [
                  ...(e[170] ||
                    (e[170] = [
