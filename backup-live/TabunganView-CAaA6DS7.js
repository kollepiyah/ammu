const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/index-CPbTnm_Q.js', 'assets/index-CbTM4Qhb.css'])
) => i.map((i) => d[i])
import {
  ab as gt,
  ae as kt,
...
import { _ as _t } from './logo-CxXS7KxG.js'
import { u as St } from './useKeuangan-DZnCnTXF.js'
import { u as Ct } from './useToast-BjwjYk11.js'
import { a as x, b as tt } from './format-BMPXVxa_.js'
const Mt = { class: 'p-3 md:p-5 max-w-5xl mx-auto space-y-4' },
  Tt = {
    key: 0,
    class:
  ...
  Lt = { class: 'text-3xl md:text-4xl font-black mt-1 drop-shadow' },
  Ot = {
    class:
  ...
  Dt = { class: 'text-[10px] text-slate-400 font-bold' },
  jt = { key: 0, class: 'p-10 text-center' },
  At = { key: 1, class: 'p-10 border-t-2 border-dashed border-slate-200 text-center' },
  Et = { key: 2, class: 'overflow-x-auto' },
  Ut = { class: 'w-full text-sm' },
  Ft = { class: 'px-4 py-2.5 text-xs text-slate-700 dark:text-slate-300 whitespace-nowrap' },
  Kt = { class: 'px-4 py-2.5' },
  Rt = {
    class:
      'px-4 py-2.5 text-right text-xs font-bold text-slate-700 dark:text-slate-300 whitespace-nowrap'
  },
  Bt = { class: 'px-4 py-2.5 text-xs text-slate-500 dark:text-slate-400 truncate max-w-[200px]' },
  Pt = {
    class:
      'bg-white dark:bg-slate-800 rounded-2xl p-4 md:p-5 border border-slate-200 dark:border-slate-700 shadow-sm'
  },
  Jt = { class: 'flex flex-col md:flex-row md:items-center md:justify-between gap-3' },
  zt = { class: 'flex flex-wrap gap-2 items-center' },
  Ht = {
    class:
      'px-3 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-700 text-xs'
  },
  Qt = { class: 'text-emerald-700 dark:text-emerald-300 font-bold' },
  qt = {
    class:
      'bg-white dark:bg-slate-800 rounded-2xl p-3 md:p-4 border border-slate-200 dark:border-slate-700 shadow-sm'
  },
  Gt = { class: 'relative' },
  Wt = { key: 0, class: 'bg-white dark:bg-slate-800 rounded-2xl p-10 text-center' },
  Xt = {
    key: 1,
    class:
      'bg-white dark:bg-slate-800 rounded-2xl p-10 border border-dashed border-slate-300 text-center'
  },
  Yt = { key: 2, class: 'bg-rose-50 border border-rose-200 rounded-xl p-3 mb-2' },
  Zt = { class: 'flex items-center justify-between gap-2 flex-wrap' },
  te = { class: 'text-xs font-bold text-rose-800' },
  ee = { class: 'flex gap-1.5 flex-wrap' },
  ae = ['disabled'],
  se = { key: 3, class: 'space-y-2' },
  le = { class: 'flex items-center gap-3' },
  ne = { class: 'flex-1 min-w-0' },
  re = { class: 'text-sm font-bold text-slate-800 dark:text-white truncate' },
  oe = { class: 'text-[10px] text-slate-500' },
  ie = { class: 'text-base font-black text-emerald-700 dark:text-emerald-400 mr-2' },
  de = { class: 'flex gap-1' },
  ue = ['onClick'],
  pe = ['onClick'],
  ce = {
  ...
  be = { id: 'tabungan-santri-list' },
  xe = ['value'],
  me = { key: 0, class: 'text-[10px] mt-1 text-emerald-700 font-bold' },
  fe = { key: 1, class: 'text-[10px] mt-1 text-rose-600 font-bold' },
  ge = { class: 'grid grid-cols-2 gap-2' },
  ke = ['value'],
  ve = {
    class: 'text-[10px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-400'
  },
  he = { key: 0, class: 'text-emerald-600 normal-case font-bold ml-1' },
  we = { class: 'text-[10px] mt-1 text-slate-500' },
  ye = {
    class:
  ...
  Ie = {
    ...
    setup(Se) {
      const {
        ...
        U = u(() => {
          var s
          return ((s = A.sesiAktif) == null ? void 0 : s.role) === 'santri'
        }),
        st = u(() => {
          var s
          return ((s = A.sesiAktif) == null ? void 0 : s.nama) || '-'
        }),
        q = u(() => {
          var s
          return String(((s = A.sesiAktif) == null ? void 0 : s.id) || '')
        }),
        lt = u(() => {
          let s = 0
          for (const t of N.value) {
            ...
            const a = Number(t.nominal) || 0,
              l = String(t.jenis || '').toLowerCase()
            l === 'setor' ? (s += a) : l === 'tarik' && (s -= a)
          }
          return s
        }),
        nt = u(() => x(lt.value)),
      ...
      ;(vt(() => {
        U.value &&
          (I = ht('keuangan_tabungan_santri', (s) => {
            N.value = s
          }))
      }),
        wt(() => {
      ...
      const K = p(''),
        w = u(() => {
          const s = {}
          for (const t of et.value) {
            const a = String(t.santri_id || t.santriId || '')
            if (!a) continue
            s[a] ||
              (s[a] = { santri_id: a, saldo: 0, terakhir_update: '', nama_cache: t.nama || '' })
            const l = Number(t.nominal) || 0,
              b = String(t.jenis || '').toLowerCase()
            b === 'setor' ? (s[a].saldo += l) : b === 'tarik' && (s[a].saldo -= l)
            const C = String(t.tanggal || '')
            C && C > s[a].terakhir_update && (s[a].terakhir_update = C)
          }
          return Object.values(s)
        }),
        G = u(() => {
          const s = K.value.trim().toLowerCase()
          let t = [...w.value]
          return (
            s &&
              (t = t.filter((a) =>
                ($(a.santri_id) || a.nama_cache || '').toLowerCase().includes(s)
              )),
            t.sort((a, l) => (Number(l.saldo) || 0) - (Number(a.saldo) || 0))
          )
        }),
        c = u(() => {
          const s = w.value.filter((t) => $(t.santri_id) === '(unknown)' && !t.nama_cache)
          return {
            count: s.length,
      ...
      async function rt() {
        ...
        const t = `Hapus PERMANEN ${c.value.count} mutasi orphan?

santri_id: ${s.join(', ')}
Total saldo: ${x(c.value.totalSaldo)}
...
Mutasi ini akan hilang dari database. Tidak bisa di-undo.`
        ...
        let a = 0,
          l = 0
        try {
          const { deleteDoc: b, doc: C } = await Z(
              async () => {
                const { deleteDoc: m, doc: M } = await import('./index-CPbTnm_Q.js').then(
                  (ft) => ft.x
                )
                return { deleteDoc: m, doc: M }
              },
              __vite__mapDeps([0, 1])
            ),
            { db: xt } = await Z(
              async () => {
                const { db: m } = await import('./index-CPbTnm_Q.js').then((M) => M.r)
                return { db: m }
              },
              __vite__mapDeps([0, 1])
            ),
            mt = N.value.filter((m) => s.includes(m.santri_id))
          for (const m of mt)
            try {
              ;(await b(C(xt, 'keuangan_tabungan_santri', String(m.id))), a++)
            } catch (M) {
              ;(l++, console.error('[cleanupOrphan] gagal hapus', m.id, M))
            }
          l > 0
            ? E.warning(`Cleanup: ${a} hapus, ${l} gagal — cek console`)
            : E.success(`${a} mutasi orphan dihapus`)
        } catch (b) {
          E.error('Gagal cleanup: ' + (b.message || b))
        } finally {
          y.value = !1
        }
      }
      function ot() {
        ;(console.group('[TabunganView] Orphan mutasi diagnostic'),
          console.log('Orphan santri_id list:', c.value.ids),
          console.log('Total saldo orphan:', c.value.totalSaldo),
          console.log(
            'Detail:',
            w.value.filter((s) => c.value.ids.includes(s.santri_id))
          ),
          console.groupEnd(),
          alert(
            'Orphan dump tersimpan di console (F12). ' +
              c.value.count +
              ' santri_id tidak terhubung ke koleksi santri.'
          ))
      }
      const it = u(() => x(w.value.reduce((s, t) => s + (Number(t.saldo) || 0), 0))),
        L = p(!1),
        f = p(''),
        k = p(''),
        R = p('setor'),
        ...
        O = u(() => {
          var t
          const s = (t = at.settings) == null ? void 0 : t.keuTagihanJenis
      ...
      function dt(s) {
        var t
        return ((t = O.value.find((a) => a.id === s)) == null ? void 0 : t.label) || s
      }
      const ut = u(() => {
          if (!f.value) return 0
          const s = w.value.find((t) => String(t.santri_id) === String(f.value))
      ...
      function P(s = '', t = 'setor') {
        ;((L.value = !0), (R.value = t), (_.value = 'syahriyah'), (B.value = ''))
        const a = O.value.find((l) => l.id === 'syahriyah')
        if (
          ((g.value = (a == null ? void 0 : a.nominal_default) || 0),
          (S.value = ((a == null ? void 0 : a.nominal_default) || 0) > 0),
          s)
        ) {
          const l = (j.value || []).find((b) => String(b.id) === String(s))
          l &&
            ((f.value = String(l.id)),
            (k.value = `${l.nama} (${l.lembaga || ''} - ${l.kelas || ''})`))
      ...
      function ct() {
        const t = (k.value || '').trim().split(' (')[0].trim().toLowerCase(),
          a = (j.value || []).find((l) => l.aktif !== !1 && (l.nama || '').toLowerCase() === t)
        f.value = a ? String(a.id) : ''
      }
      function bt() {
        const s = O.value.find((t) => t.id === _.value)
        s && s.nominal_default > 0
          ? ((g.value = s.nominal_default), (S.value = !0))
          : (S.value = !1)
      }
      return (
        yt(g, () => {
                    ...
                    [
                      ...
                      e('div', Ot, [
                        e('div', Vt, [
                          ...
                          e('span', Dt, o(F.value.length) + ' transaksi', 1)
                        ]),
                        i(H)
                          ? (r(),
                            n('div', jt, [
                                        ...
                                        (a) => (
                                          ...
                                          n(
                                            ...
                                            [
                                              ...
                                              e('td', Rt, o(i(x)(a.saldo_after || a.saldo)), 1),
                                              e('td', Bt, o(a.catatan || '-'), 1)
                                            ]
                                          )
                                        )
                                      ),
                    ...
                    [
                      e('div', Pt, [
                        e('div', Jt, [
                          ...
                          e('div', zt, [
                            e('div', Ht, [e('span', Qt, o(it.value), 1)]),
                            e(
                              'button',
                              {
                                onClick: t[0] || (t[0] = (a) => P()),
                                      ...
                                      [
                                        e(
                                          'i',
                                          {
                                            class: z([
                                              'fas',
                                              y.value ? 'fa-spinner fa-spin' : 'fa-broom',
                                              'mr-1'
                                            ])
                                          },
                                          null,
                                        ...
                                        d(o(y.value ? 'Membersihkan...' : 'Hapus Mutasi Orphan'), 1)
                                      ],
                                      8,
                                      ae
                                    ))
                                  ...
                                  n(
                                    ...
                                    [
                                      e('div', le, [
                                        ...
                                        e('p', ie, o(i(x)(a.saldo)), 1),
                                        e('div', de, [
                                          e(
                                            'button',
                                            {
                                              onClick: (l) => P(a.santri_id, 'setor'),
                                              class:
                    ...
                    e('div', ce, [
                      e(
                        ...
                        [
                          ...
                          e(
                            'button',
                            { onClick: J, class: 'text-slate-400 hover:text-slate-700' },
                            [
                              ...(t[27] ||
                                (t[27] = [e('i', { class: 'fas fa-times text-lg' }, null, -1)]))
                            ]
                          )
                        ]
                      ),
                      e(
                        'form',
                        {
                          onSubmit:
                            t[7] ||
                            (t[7] = X(
                              (...a) => s.simpanMutasi && s.simpanMutasi(...a),
                              ['prevent']
                            )),
                          class: 'p-5 space-y-3'
                        },
                        [
                            ...
                            f.value
                              ? (r(),
                                n('p', me, [
                                  ...
                                  d('Saldo: ' + o(i(x)(ut.value)), 1)
                                ]))
                              : k.value.length >= 2
                                ? (r(), n('p', fe, ' Santri tidak ditemukan — pilih dari saran. '))
                                : T('', !0)
                          ]),
                          e('div', ge, [
                            e('div', null, [
                            ...
                            e('div', null, [
                              ...
                              h(
                                e(
                                  'select',
                                  {
                                    'onUpdate:modelValue': t[4] || (t[4] = (a) => (_.value = a)),
                                    onChange: bt,
                                    class:
                                      'w-full mt-1 px-3 py-2 text-sm rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 focus:ring-2 focus:ring-emerald-500 outline-none'
                                  },
                                  [
                                    ...
                                    n(
                                      ...
                                      V(
                                        ...
                                        (a) => (
                                          r(),
                                          n('option', { key: a.id, value: a.id }, o(a.label), 9, ke)
                                        )
                                      ),
                                      128
                                    ))
                          ...
                          e('div', null, [
                            e('label', ve, [
                              t[35] || (t[35] = d(' Nominal ', -1)),
                              S.value
                                ? (r(),
                                  n('span', he, [
                                    t[34] ||
                                      (t[34] = e('i', { class: 'fas fa-magic mr-1' }, null, -1)),
                                    d('auto-fill ' + o(dt(_.value)), 1)
                                  ]))
                                : T('', !0)
                            ]),
                            h(
                              e(
                                'input',
                                {
                                  'onUpdate:modelValue': t[5] || (t[5] = (a) => (g.value = a)),
                                  type: 'number',
                                  min: '0',
                                  placeholder: 'Rp 0',
                                  class:
                          ...
                          e('div', null, [
                            ...
                            h(
                              e(
                                'input',
                                {
                                  'onUpdate:modelValue': t[6] || (t[6] = (a) => (B.value = a)),
                                  type: 'text',
                          ...
                          e('div', ye, [
                            ...
                            e(
                              ...
                              {
                                type: 'submit',
                                disabled: W.value || !f.value || !g.value,
                                class:
                              ...
                              [
                                t[37] || (t[37] = e('i', { class: 'fas fa-save mr-1' }, null, -1)),
                                d(o(W.value ? 'Menyimpan...' : 'Simpan'), 1)
                              ],
                              8,
                              _e
                            )
