/* Ammu Online — icon set. Office-style line icons. window.Icon */
(function () {
  // 24x24 viewBox path data. f = filled (uses fill), default = stroke.
  const P = {
    ...
    "file-text": "M7 3h7l5 5v12a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1ZM14 3v5h5M9 13h6M9 17h4",
    image: "M4 5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1zM4 16l4-4 4 4 3-3 5 5M9 9.5a1.2 1.2 0 1 0 0-.1Z",
    ...
    language: "M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM3 12h18M12 3c2.5 2.4 4 5.6 4 9s-1.5 6.6-4 9c-2.5-2.4-4-5.6-4-9s1.5-6.6 4-9Z",
    ...
    palette: "M12 3a9 9 0 0 0 0 18 2 2 0 0 0 2-2 1.8 1.8 0 0 1 1.8-1.8H18a3 3 0 0 0 3-3A8 8 0 0 0 12 3ZM7.5 11.5h.01M10.5 8h.01M14 8h.01M16.5 11h.01",
    ...
    audio: "M9 18V6l9-2v12M9 18a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0ZM18 16a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z",
    photo: "M4 5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1zM4 16l4-4 4 4 3-3 5 5M9 9.5a1.2 1.2 0 1 0 0-.1Z",
    doc: "M7 3h7l5 5v12a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1ZM14 3v5h5M9 13h6M9 17h4",
    post: "M5 19h3l9.5-9.5a1.8 1.8 0 0 0-2.5-2.5L5.5 16.5 5 19ZM14 7l3 3",
    wallet: "M3 8a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2H5a1 1 0 0 0 0 2h14a1 1 0 0 1 1 1v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zM16 13a1.5 1.5 0 0 0 0 3h4v-3z",
  };
