...
// ====================================================================
// CATATAN INSTALASI FUNCTION 3 (cleanupAuditLog):
//
// 1. Pastikan Firebase plan = Blaze (Cloud Scheduler butuh Blaze)
// 2. Deploy: firebase deploy --only functions:cleanupAuditLog
// 3. Cek di Firebase Console → Cloud Scheduler:
//    Job "firebase-schedule-cleanupAuditLog-asia-southeast2" akan run jam 02:00 WIB
// 4. Untuk test manual: di Console Cloud Scheduler, klik "RUN NOW" pada job
// 5. Untuk ubah retensi (default 90 hari), ubah konstanta RETENSI_HARI di atas.
// ===================================================================
