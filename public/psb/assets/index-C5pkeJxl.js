...
* @license MIT
**/function Ua(e){const t=Object.create(null);for(const n of e.split(","))t[n]=1;return n=>n in t}const kt={},Ir=[],Ye=()=>{},_h=()=>!1,Zi=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),to=e=>e.startsWith("onUpdate:"),ae=Object.assign,Ba=(e,t)=>{const n=e.indexOf(t);n>-1&&e.splice(n,1)},Hp=Object.prototype.hasOwnProperty,Pt=(e,t)=>Hp.call(e,t),ot=Array.isArray,Ar=e=>Bs(e)==="[object Map]",Fr=e=>Bs(e)==="[object Set]",Fu=e=>Bs(e)==="[object Date]",ht=e=>typeof e=="function",$t=e=>typeof e=="string",Ze=e=>typeof e=="symbol",Vt=e=>e!==null&&typeof e=="object",yh=e=>(Vt(e)||ht(e))&&ht(e.then)&&ht(e.catch),vh=Object.prototype.toString,Bs=e=>vh.call(e),zp=e=>Bs(e).slice(8,-1),Eh=e=>Bs(e)==="[object Object]",ja=e=>$t(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,ds=Ua(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),eo=e=>{const t=Object.create(null);return(n=>t[n]||(t[n]=e(n)))},Wp=/-\w/g,je=eo(e=>e.replace(Wp,t=>t.slice(1).toUpperCase())),Gp=/\B([A-Z])/g,or=eo(e=>e.replace(Gp,"-$1").toLowerCase()),Th=eo(e=>e.charAt(0).toUpperCase()+e.slice(1)),Uo=eo(e=>e?`on${Th(e)}`:""),Qe=(e,t)=>!Object.is(e,t),Ai=(e,...t)=>{for(let n=0;n<e.length;n++)e[n](...t)},wh=(e,t,n,r=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:r,value:n})},no=e=>{const t=parseFloat(e);return isNaN(t)?e:t};let Uu;const ro=()=>Uu||(Uu=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function $a(e){if(ot(e)){const t={};for(let n=0;n<e.length;n++){const r=e[n],s=$t(r)?Jp(r):$a(r);if(s)for(const i in s)t[i]=s[i]}return t}else if($t(e)||Vt(e))return e}const Qp=/;(?![^(]*\))/g,Xp=/:([^]+)/,Yp=/\/\*[^]*?\*\//g;function Jp(e){const t={};return e.replace(Yp,"").split(Qp).forEach(n=>{if(n){const r=n.split(Xp);r.length>1&&(t[r[0].trim()]=r[1].trim())}}),t}function qa(e){let t="";if($t(e))t=e;else if(ot(e))for(let n=0;n<e.length;n++){const r=qa(e[n]);r&&(t+=r+" ")}else if(Vt(e))for(const n in e)e[n]&&(t+=n+" ");return t.trim()}const Zp="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",tm=Ua(Zp);function Ih(e){return!!e||e===""}function em(e,t){if(e.length!==t.length)return!1;let n=!0;for(let r=0;n&&r<e.length;r++)n=Nn(e[r],t[r]);return n}function Nn(e,t){if(e===t)return!0;let n=Fu(e),r=Fu(t);if(n||r)return n&&r?e.getTime()===t.getTime():!1;if(n=Ze(e),r=Ze(t),n||r)return e===t;if(n=ot(e),r=ot(t),n||r)return n&&r?em(e,t):!1;if(n=Vt(e),r=Vt(t),n||r){if(!n||!r)return!1;const s=Object.keys(e).length,i=Object.keys(t).length;if(s!==i)return!1;for(const a in e){const l=e.hasOwnProperty(a),c=t.hasOwnProperty(a);if(l&&!c||!l&&c||!Nn(e[a],t[a]))return!1}}return String(e)===String(t)}function Ka(e,t){return e.findIndex(n=>Nn(n,t))}const Ah=e=>!!(e&&e.__v_isRef===!0),ne=e=>$t(e)?e:e==null?"":ot(e)||Vt(e)&&(e.toString===vh||!ht(e.toString))?Ah(e)?ne(e.value):JSON.stringify(e,bh,2):String(e),bh=(e,t)=>Ah(t)?bh(e,t.value):Ar(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((n,[r,s],i)=>(n[Bo(r,i)+" =>"]=s,n),{})}:Fr(t)?{[`Set(${t.size})`]:[...t.values()].map(n=>Bo(n))}:Ze(t)?Bo(t):Vt(t)&&!ot(t)&&!Eh(t)?String(t):t,Bo=(e,t="")=>{var n;return Ze(e)?`Symbol(${(n=e.description)!=null?n:t})`:e};/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt extends ar{constructor(t,n,r=0){super(sa(t),`Firebase Storage: ${n} (${sa(t)})`),this.status_=r,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,Kt.prototype)}get status(){return this.status_}set status(t){this.status_=t}_codeEquals(t){return sa(t)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(t){this.customData.serverResponse=t,this.customData.serverResponse?this.message=`${this._baseMessage}
${this.customData.serverResponse}`:this.message=this._baseMessage}}var qt;(function(e){e.UNKNOWN="unknown",e.OBJECT_NOT_FOUND="object-not-found",e.BUCKET_NOT_FOUND="bucket-not-found",e.PROJECT_NOT_FOUND="project-not-found",e.QUOTA_EXCEEDED="quota-exceeded",e.UNAUTHENTICATED="unauthenticated",e.UNAUTHORIZED="unauthorized",e.UNAUTHORIZED_APP="unauthorized-app",e.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",e.INVALID_CHECKSUM="invalid-checksum",e.CANCELED="canceled",e.INVALID_EVENT_NAME="invalid-event-name",e.INVALID_URL="invalid-url",e.INVALID_DEFAULT_BUCKET="invalid-default-bucket",e.NO_DEFAULT_BUCKET="no-default-bucket",e.CANNOT_SLICE_BLOB="cannot-slice-blob",e.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",e.NO_DOWNLOAD_URL="no-download-url",e.INVALID_ARGUMENT="invalid-argument",e.INVALID_ARGUMENT_COUNT="invalid-argument-count",e.APP_DELETED="app-deleted",e.INVALID_ROOT_OPERATION="invalid-root-operation",e.INVALID_FORMAT="invalid-format",e.INTERNAL_ERROR="internal-error",e.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(qt||(qt={}));function sa(e){return"storage/"+e}function $l(){const e="An unknown error occurred, please check the error payload for server response.";return new Kt(qt.UNKNOWN,e)}function ew(e){return new Kt(qt.OBJECT_NOT_FOUND,"Object '"+e+"' does not exist.")}function nw(e){return new Kt(qt.QUOTA_EXCEEDED,"Quota for bucket '"+e+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function rw(){const e="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new Kt(qt.UNAUTHENTICATED,e)}function sw(){return new Kt(qt.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function iw(e){return new Kt(qt.UNAUTHORIZED,"User does not have permission to access '"+e+"'.")}function ow(){return new Kt(qt.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function aw(){return new Kt(qt.CANCELED,"User canceled the upload/download.")}function lw(e){return new Kt(qt.INVALID_URL,"Invalid URL '"+e+"'.")}function uw(e){return new Kt(qt.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+e+"'.")}function cw(){return new Kt(qt.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+ip+"' property when initializing the app?")}function hw(){return new Kt(qt.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function fw(){return new Kt(qt.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function dw(e){return new Kt(qt.UNSUPPORTED_ENVIRONMENT,`${e} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function Fa(e){return new Kt(qt.INVALID_ARGUMENT,e)}function op(){return new Kt(qt.APP_DELETED,"The Firebase app was deleted.")}function pw(e){return new Kt(qt.INVALID_ROOT_OPERATION,"The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function bs(e,t){return new Kt(qt.INVALID_FORMAT,"String does not match format '"+e+"': "+t)}function as(e){throw new Kt(qt.INTERNAL_ERROR,"Internal error: "+e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
