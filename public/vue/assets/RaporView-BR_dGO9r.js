...
import { u as ge } from './useSantri-DJehexBi.js'
import { u as ke } from './useLembaga--Gos7VCc.js'
import { u as he } from './useGuru-D5SD6T31.js'
import { u as fe } from './useToast-DlBPYiJY.js'
import { _ as Rt } from './UiActionCard-537RTLKg.js'
import { _ as ve } from './_plugin-vue_export-helper-DlAUqK2U.js'
const xe = { class: 'p-4 md:p-6 max-w-5xl mx-auto' },
  _e = {
    key: 0,
    class:
      'bg-emerald-50/40 dark:bg-slate-800 rounded-2xl p-5 md:p-6 border border-emerald-100 dark:border-slate-700 shadow-sm'
  },
  ye = { class: 'grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 mb-4' },
  we = ['value'],
  Se = { class: 'grid grid-cols-2 gap-2 md:gap-3' },
  Le = {
    key: 1,
    class:
      'bg-emerald-50/40 dark:bg-slate-800 rounded-2xl p-5 md:p-6 border border-emerald-100 dark:border-slate-700 shadow-sm'
  },
  Ae = { class: 'flex items-center gap-3 mb-4' },
  Ke = { class: 'text-lg md:text-xl font-black text-slate-800 dark:text-white leading-tight' },
  Te = { class: 'text-xs md:text-sm text-slate-500 dark:text-slate-400 mt-0.5' },
  Ie = { key: 0, class: 'grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3' },
  Pe = ['onClick'],
  Ce = { class: 'text-sm md:text-base font-black leading-tight drop-shadow-sm' },
  Ne = { class: 'text-[10px] text-white/90 font-medium leading-snug' },
  $e = { key: 1 },
  je = { key: 0, class: 'text-center py-8 text-xs text-slate-400 italic' },
  De = { key: 1, class: 'grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3' },
  qe = ['onClick'],
  Re = { class: 'text-sm md:text-base font-black leading-tight drop-shadow-sm' },
  ze = { class: 'text-[10px] text-white/90 font-medium leading-snug' },
  Ee = { key: 2, class: 'space-y-4' },
  Be = {
    class:
      'bg-white dark:bg-slate-800 rounded-2xl p-4 md:p-5 border border-slate-200 dark:border-slate-700 shadow-sm'
  },
  Fe = { class: 'flex items-center justify-between gap-3 flex-wrap mb-3' },
  Je = { class: 'flex items-center gap-2' },
  Me = { class: 'text-base md:text-lg font-black text-slate-800 dark:text-white' },
  Ue = { class: 'text-[10px] text-slate-400 font-bold' },
  He = { class: 'grid grid-cols-1 md:grid-cols-2 gap-2' },
  Ge = ['value'],
  Qe = {
    key: 0,
    class:
  ...
  Ve = { class: 'text-sm font-bold text-slate-700 dark:text-slate-300' },
  Oe = { class: 'text-xs text-slate-500 mt-1' },
  We = { key: 1, class: 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-3' },
  Ye = ['onClick'],
  Xe = {
    class:
  ...
  ta = { class: 'text-sm font-bold text-slate-800 dark:text-white truncate' },
  ea = ['title'],
  aa = { class: 'text-[10px] text-slate-500 dark:text-slate-400 truncate' },
  la = { class: 'font-bold' },
  ra = { key: 0, class: 'ml-1' },
  sa = { key: 1, class: 'ml-1 text-purple-600 font-bold' },
  na = { key: 3, class: 'space-y-4' },
  oa = {
    class:
      'no-print bg-white dark:bg-slate-800 rounded-2xl p-4 md:p-5 border border-slate-200 dark:border-slate-700 shadow-sm'
  },
  ia = { class: 'flex items-center justify-between gap-3 flex-wrap' },
  da = { class: 'flex items-center gap-2' },
  ua = { class: 'text-base md:text-lg font-black text-slate-800 dark:text-white' },
  pa = {
    key: 0,
    class:
  ...
  ga = ['src'],
  ka = { class: 'relative', style: { 'z-index': '1' } },
  ha = { class: 'w-full border-b-2 border-black pb-1.5 mb-2' },
  fa = { class: 'w-[95px] text-center align-middle' },
  va = ['src'],
  xa = { class: 'text-center align-middle px-2 py-0.5' },
  _a = { key: 0, class: 'text-[14px] font-normal uppercase leading-tight' },
  ya = { key: 1, class: 'text-[22px] font-bold uppercase leading-tight' },
  wa = { key: 2, class: 'text-[12px] font-normal leading-tight text-slate-700' },
  Sa = { key: 3, class: 'text-[12px] font-normal leading-tight text-slate-700' },
  La = { class: 'w-[95px] text-center align-middle' },
  Aa = ['src'],
  Ka = { class: 'text-center text-[13px] font-bold underline my-2.5 leading-snug' },
  Ta = { class: 'w-full text-[11px] mb-2' },
  Ia = { key: 0 },
  Pa = { class: 'py-0.5' },
  Ca = { class: 'py-0.5' },
  Na = { class: 'py-0.5', colspan: '4' },
  $a = { key: 1 },
  ja = { class: 'py-0.5' },
  Da = { class: 'py-0.5' },
  qa = { class: 'py-0.5', colspan: '4' },
  Ra = { key: 0, class: 'mt-3' },
  za = { class: 'w-full border-collapse text-[9px] leading-snug' },
  Ea = { class: 'bg-slate-200' },
  Ba = ['rowspan'],
  Fa = ['rowspan'],
  Ja = { class: 'border border-black px-1 py-1.5 align-middle' },
  Ma = { class: 'border border-black px-1 py-1.5 text-center align-middle' },
  Ua = { class: 'border border-black px-1 py-1.5 text-center font-bold align-middle' },
  Ha = { class: 'bg-slate-100' },
  Ga = ['colspan'],
  Qa = { class: 'bg-amber-50' },
  Va = ['colspan'],
  Oa = { class: 'border border-black px-1 py-1 text-center font-bold' },
  Wa = { key: 1, class: 'mt-3' },
  Ya = {
    key: 0,
    class:
  ...
  Xa = { key: 1, class: 'w-full border-collapse text-[11px]' },
  Za = { class: 'border border-black px-2 py-1.5 text-center font-bold' },
  tl = { class: 'border border-black px-2 py-1.5' },
  el = { class: 'border border-black px-2 py-1.5 text-center' },
  al = { class: 'border border-black px-2 py-1.5 text-center' },
  ll = { class: 'border border-black px-2 py-1.5 text-center' },
  rl = { key: 2, class: 'overflow-x-auto' },
  sl = { class: 'text-[11px] font-bold text-slate-600 mb-1 px-1' },
  nl = { class: 'border-collapse text-[10px] md:text-[11px] w-full min-w-[600px] table-fixed' },
  ol = { class: 'bg-slate-100' },
  il = ['colspan'],
  dl = { key: 1, rowspan: '2', class: 'border border-slate-500 px-1.5 py-1 align-middle' },
  ul = ['rowspan'],
  pl = { class: 'border border-slate-500 px-1.5 py-1 text-center font-bold' },
  bl = { key: 0 },
  ml = ['colspan'],
  cl = { key: 3 },
  gl = {
  ...
  kl = { key: 0, class: 'w-full border-collapse text-[10px]' },
  hl = { class: 'bg-slate-100' },
  fl = { key: 0 },
  vl = { rowspan: '2', class: 'border border-slate-500 px-1 py-1 w-[50px] align-middle' },
  xl = ['colspan'],
  _l = { key: 1, rowspan: '2', class: 'border border-slate-500 px-1 py-1 align-middle' },
  yl = { key: 1 },
  wl = { key: 2 },
  Sl = { class: 'border border-slate-500 px-1 py-1 w-[50px]' },
  Ll = { class: 'border border-slate-500 px-1 py-1 w-[50px]' },
  Al = { key: 1, class: 'w-full border-collapse text-[10px]' },
  Kl = { class: 'bg-slate-100' },
  Tl = {
    key: 4,
    class:
      'text-[11px] italic text-slate-500 my-3 border border-dashed border-slate-300 rounded p-3 text-center'
  },
  Il = { class: 'w-full border-collapse text-[11px] mt-3' },
  Pl = { class: 'border border-slate-500 px-1.5 py-1 text-center font-bold' },
  Cl = { class: 'w-full text-[10px] mt-2' },
  Nl = { class: 'align-top w-1/2 pr-3' },
  $l = { class: 'my-0.5' },
  jl = { class: 'my-0.5' },
  Dl = { class: 'my-0.5' },
  ql = { class: 'align-top w-1/2' },
  Rl = { class: 'my-0.5' },
  zl = { class: 'my-0.5' },
  El = { class: 'my-0.5' },
  Bl = { class: 'border border-slate-500 p-1.5 mt-2 text-[10px] min-h-[18mm]' },
  Fl = { class: 'm-0 whitespace-pre-line' },
  Jl = { class: 'mt-8 text-[10px]' },
  Ml = { class: 'w-full text-center' },
  Ul = { class: 'w-1/3' },
  Hl = { style: { height: '60px', 'vertical-align': 'bottom' } },
  Gl = ['src'],
  Ql = ['src'],
  Vl = { class: 'underline font-bold' },
  Ol = { class: 'underline font-bold' },
  Wl = { class: 'underline font-bold' },
    ...
    setup(Zl) {
      ...
      const { santriRaw: O, getRapors: B } = ge(),
        ...
        it = m(() => {
          const e = N.sesiAktif
          return (
            (e == null ? void 0 : e.role) === 'guru' &&
            (e == null ? void 0 : e.role_sistem) !== 'super_admin' &&
            (e == null ? void 0 : e.role_sistem) !== 'admin' &&
            (e == null ? void 0 : e.role_sistem) !== 'admin_keuangan'
          )
        }),
        Y = m(() => {
          var e
          return ((e = N.sesiAktif) == null ? void 0 : e.role) === 'santri'
        }),
        y = T('picker'),
        f = T(''),
        S = T(''),
        z = T(Y.value ? String(((jt = N.sesiAktif) == null ? void 0 : jt.id) || '') : ''),
        D = T(''),
        q = T(''),
        X = [
          {
        ...
        J = new Date(),
        $ = T(`${J.getFullYear()}-${J.getFullYear() + 1}`),
        j = T(J.getMonth() < 6 ? 'Genap' : 'Ganjil'),
        Et = m(() => {
          const e = J.getFullYear()
        ...
        Z = m(() => {
          ...
          if (it.value) {
            const n = String(((r = N.sesiAktif) == null ? void 0 : r.id) || '').toLowerCase(),
              l = String(((s = N.sesiAktif) == null ? void 0 : s.nama) || '')
                .toLowerCase()
                .trim()
            t = t.filter((u) => {
          ...
          if (
            (D.value && (t = t.filter((n) => String(n.kelas || '') === D.value)), q.value.trim())
          ) {
        ...
        Bt = m(() => {
          ...
          return (
            O.value.forEach((r) => {
              const s = String(r.lembaga || '')
                  .toLowerCase()
                  .trim(),
                n = String(r.lembaga_sekolah || '')
                  .toLowerCase()
                  .trim()
              ;(f.value === 'qiraati' ? s === e : n === e || (!n && s === e)) &&
                r.kelas &&
                t.add(String(r.kelas))
            }),
            [...t].sort()
          )
        }),
        b = m(() => O.value.find((e) => String(e.id) === String(z.value)) || null),
        dt = m(() => {
          if (!b.value) return []
          const e = B(b.value) || [],
            t = String(S.value || '')
      ...
      function Ft(e) {
        ;((f.value = e.jenis), (S.value = e.lembaga), (y.value = 'detail'))
      }
      const I = m(() => {
          const e = A.settings || {}
          let t = {}
          if (b.value) {
            const r = String(b.value.lembaga || '')
              .toLowerCase()
              .trim()
            t =
              (F.value || []).find(
        ...
        pt = m(() => {
          ...
          if (!b.value) return ''
          const e = String(
            f.value === 'diniyah' ? b.value.lembaga_sekolah || '' : b.value.lembaga || ''
          )
            .toLowerCase()
            .trim()
          return (
      ...
      const mt = m(() => {
          const e = A.settings || {}
          return f.value === 'diniyah' ? e.bgRaporDiniyah || '' : e.bgRaporTPQ || ''
        }),
        ct = m(() => {
          const e = Kt.value
          if (!e || e === '-') return ''
          const t = (W.value || []).find(
            (r) => String(r.nama || '').toLowerCase() === String(e).toLowerCase()
          )
          return (
        ...
        gt = m(() => {
          const e = (W.value || []).find((t) => {
            const r = String(t.role_sistem || '').toLowerCase(),
              s = String(t.jabatan || '').toLowerCase()
            return (
              r === 'super_admin' || r === 'admin' || s.includes('kepala') || s.includes('pengasuh')
            )
          })
          return (
            (e == null ? void 0 : e.tanda_tangan) ||
            (e == null ? void 0 : e.ttd_url) ||
            (e == null ? void 0 : e.ttd) ||
            ''
          )
        }),
      ...
      function ht(e) {
        ...
        if (t === 'ptpt' || t === 'ppph') {
          ...
          for (let n = 1; n <= 6; n++) {
            const l = (n - 1) * 5 + 1
            for (let u = l; u <= l + 4; u++) s.push({ kelas: 'Kelas ' + n, juz: 'Juz ' + u })
          }
          return { tableLayout: 'kelasJuz', fields: r, rows: s }
        }
        return t === 'tpq' || t === 'tpq pagi' || t === 'tpq sore'
          ? {
              sections: [
                {
                  id: 'jilid',
      ...
      const c = m(() => {
          ...
          if (r === 'tpq pagi' || r === 'tpq sore') {
            const u = n.find((p) => String(p).toLowerCase().trim() === 'tpq')
            u && (s = t[u])
          }
          if (!s) {
            const u = n.find((p) => String(p).toLowerCase().trim() === r)
            u && (s = t[u])
          }
          if (s && Object.keys(s).length > 0) {
            const u = r === 'ptpt' || r === 'ppph' || r === 'p3h',
              p =
                s.perKelas &&
                Array.isArray(s.jenjang) &&
                s.jenjang.some(
                  (v) =>
                    Array.isArray(v.mapel) &&
                    v.mapel.some((k) => /juz/i.test(String(k.id || k.nama || '')))
                )
            return u && p ? ht(e) : s
          }
          return ht(f.value === 'diniyah' ? 'diniyah' : e)
        }),
        Mt = m(() => (Array.isArray(c.value.sections) ? c.value.sections : [])),
        R = m(() =>
          Array.isArray(c.value.fieldsNilai) && c.value.fieldsNilai.length
            ? c.value.fieldsNilai
            : kt
        ),
        M = m(() => {
          if (!c.value.perKelas || !b.value) return null
          const e = b.value.kelas_sekolah || ''
          return (
            (c.value.jenjang || []).find((t) => t.kelas === e) || (c.value.jenjang || [])[0] || null
          )
        })
      function ft(e) {
      ...
      function Ut(e) {
        ...
        for (; s < r.length; ) {
          ...
          if (n.group) {
            let l = 1,
              u = s + 1
            for (; u < r.length && r[u].group === n.group; ) (l++, u++)
            ;(t.push({ group: n.group, span: l }), (s = u))
          } else (t.push({ label: n.label }), s++)
        }
        return t
      }
      function vt(e) {
      ...
      const K = m(() => {
          ...
          const e = `${$.value}_${j.value}`.replace(/[^a-zA-Z0-9_]/g, '_'),
            t = f.value === 'diniyah' ? 'Diniyah' : b.value.lembaga || '',
            r = `rapor_${b.value.id}_${t}_${e}`
          return ot.value.find((s) => s.id === r) || null
        }),
        tt = m(() => {
          var e
          return ((e = K.value) == null ? void 0 : e.absensi) || { sakit: 0, izin: 0, alpa: 0 }
        }),
        et = m(() => {
          var e
          return (
            ((e = K.value) == null ? void 0 : e.kepribadian) || {
              kelakuan: 'Baik',
              kerajinan: 'Baik',
              kebersihan: 'Baik'
            }
        ...
        Gt = m(() => {
          var e
          return ((e = K.value) == null ? void 0 : e.catatan) || ''
        }),
        Qt = m(() => {
          var t, r, s
          const e = (t = K.value) == null ? void 0 : t.rata_rata
          if (e && Number(e) > 0) return e
          if (c.value.perKelas && M.value) {
            const n = ((r = K.value) == null ? void 0 : r.data_nilai) || {},
              l = ((s = b.value) == null ? void 0 : s.kelas_sekolah) || ''
            let u = 0,
              p = 0
            return (
              (M.value.mapel || []).forEach((v) => {
                const k = v.id || E(v.nama),
                  h = Number(n[`dn__${l}__${k}__akhir`])
                !isNaN(h) && h > 0 && ((u += h), p++)
              }),
              p > 0 ? u / p : 0
            )
          }
          return (c.value.perLevel && Wt.value) || 0
        })
      function xt(e, t) {
        const r = b.value
        if (!(r != null && r.kartu_kenaikan)) return ''
        const s = r.lembaga || '',
          n = r.kartu_kenaikan || {}
        let l = n[s]
        if (!l) {
          const h = Object.keys(n).find(
            (P) => String(P).toLowerCase().trim() === String(s).toLowerCase().trim()
          )
          l = h ? n[h] : null
        }
        ...
        const p = Array.isArray(u.entries) ? u.entries : [],
          v = p.find(
            (h) => (h == null ? void 0 : h.itemId) === t && (h == null ? void 0 : h.tanggal)
          )
        if (v) return v.tanggal
        const k = p.find((h) => (h == null ? void 0 : h.tanggal))
        return (k == null ? void 0 : k.tanggal) || ''
      }
      function U(e) {
        var t, r
        ...
        return (r = (t = K.value) == null ? void 0 : t.data_nilai) == null ? void 0 : r[e]
      }
      function Vt(e) {
        if (!e) return ''
        try {
      ...
      function H(e) {
        ...
        const t =
          ...
          r = Number(e)
        if (isNaN(r)) return '-'
        const s = t.find((l) => r >= Number(l.min) && r <= Number(l.max))
        return s ? s.label : '-'
      }
      function _t(e, t) {
        var l
        const r = ((l = K.value) == null ? void 0 : l.data_nilai) || {}
        let s = 0,
          n = 0
        return (
          R.value.forEach((u) => {
            const p = Number(r[`pra__${e}__${t}__${u.id}`])
            !isNaN(p) && p > 0 && ((s += p), n++)
          }),
          n > 0 ? s / n : null
        )
      ...
      const Wt = m(() => {
          const e = []
          return (
            (c.value.levels || []).forEach((t) => {
              ;(t.khotamList || []).forEach((r) => {
                const s = _t(t.id, r.id)
                s !== null && e.push(s)
              })
            }),
            e.length === 0 ? null : e.reduce((t, r) => t + r, 0) / e.length
          )
        }),
        Yt = m(() => {
          let e = 0,
            t = !1
          return (
            (c.value.levels || []).forEach((r) => {
              ;(r.khotamList || []).forEach((s) => {
                const n = yt(r.id, s.id)
                n !== null && ((e += n), (t = !0))
              })
            }),
            t ? e : null
      ...
      function St(e, t, r) {
        var u, p
        const s = ((u = K.value) == null ? void 0 : u.data_nilai) || {},
          n = t ? `${e}__${t}__${r.id}` : `${e}__${r.id}`
        let l = s[n]
        if (r.type === 'auto_predikat') {
          if (r.source === 'avg') {
            const v = (
              ((p = Mt.value.find((P) => P.id === e)) == null ? void 0 : p.fields) || []
            ).filter((P) => P.type === 'number')
            let k = 0,
              h = 0
            return (
              v.forEach((P) => {
                const ie = t ? `${e}__${t}__${P.id}` : `${e}__${P.id}`,
                  rt = Number(s[ie] || 0)
                !isNaN(rt) && rt > 0 && ((k += rt), h++)
              }),
              h > 0 ? H(k / h) : '-'
            )
          }
          if (r.source) {
            const v = t ? `${e}__${t}__${r.source}` : `${e}__${r.source}`,
              k = Number(s[v] || 0)
            return k > 0 ? H(k) : '-'
          }
          return '-'
      ...
      function Zt(e, t) {
        var l
        if (!e || !t) return '-'
        const r = `${at(e)}__${t.id}`,
          s = ((l = K.value) == null ? void 0 : l.data_nilai) || {},
          n = s[r]
        if (t.type === 'auto_predikat') {
          if (t.source === 'avg') {
            const u = (c.value.fields || []).filter((k) => k.type === 'number')
            let p = 0,
              v = 0
            return (
              u.forEach((k) => {
                const h = Number(s[`${at(e)}__${k.id}`] || 0)
                !isNaN(h) && h > 0 && ((p += h), v++)
              }),
              v > 0 ? H(p / v) : '-'
            )
          ...
          if (t.source) {
            const u = Number(s[`${at(e)}__${t.source}`] || 0)
            return u > 0 ? H(u) : '-'
          }
          return '-'
        }
      ...
      const te = m(() => {
          ...
          for (; r < e.length; ) {
            ...
            if (s.group) {
              let n = 1,
                l = r + 1
              for (; l < e.length && e[l].group === s.group; ) (n++, l++)
              ;(t.push({ group: s.group, span: n }), (r = l))
            } else (t.push({ label: s.label }), r++)
          }
          return t
        }),
        ee = m(() => (c.value.fields || []).filter((e) => e && e.group))
      function lt(e) {
        const t = String(e || '').match(/(\d+)/)
        return t ? parseInt(t[1], 10) : 0
      }
      const G = m(() => {
          if (c.value.tableLayout !== 'kelasJuz') return []
          const e = c.value.rows || [],
            t = b.value
          if (!t) return e
          const r = lt(t.kelas) || lt(t.kelas_sekolah)
          return r
            ? e.filter((s) => {
                const n = lt(s.kelas)
                return n > 0 && n <= r
        ...
        Lt = m(() => {
          ...
          for (; r < e.length; ) {
            let s = r
            for (; s < e.length && e[s].kelas === e[r].kelas; ) s++
            t[r] = { isFirst: !0, rowspan: s - r }
            for (let n = r + 1; n < s; n++) t[n] = { isFirst: !1, rowspan: 0 }
            r = s
          }
          return t
        })
      ...
      const At = m(() => {
          var s, n
          const e = b.value
          if (!e) return ((s = A.settings) == null ? void 0 : s.namaPengasuh) || ''
          const t = String(f.value === 'diniyah' ? e.lembaga_sekolah || '' : e.lembaga || '')
              .toLowerCase()
              .trim(),
            r =
              (F.value || []).find(
      ...
      const It = m(() => {
          ...
          for (const r of t) {
            const s = Tt(r),
              n =
                (s == null ? void 0 : s.nrg) ||
                (s == null ? void 0 : s.ekgq) ||
                (s == null ? void 0 : s.no_ekgq) ||
                (s == null ? void 0 : s.nip) ||
                ''
            if (n) return n
          }
      ...
      function Ct(e) {
        ;((f.value = e), (y.value = 'lembaga'), (D.value = ''), (q.value = ''), (z.value = ''))
      }
      const Nt = m(() => {
        const e = ['sdi', 'pkbm'],
          t = (F.value || []).filter((s) => {
            const n = String(s.lembaga || s.nama || '')
              .toLowerCase()
              .trim()
            return e.includes(n)
          })
        t.length === 0 &&
          e.forEach((s) => t.push({ lembaga: s.toUpperCase(), id: s.toUpperCase() }))
        const r = [
        ...
        return t.map((s, n) => ({
          id: s.lembaga || s.nama,
          label: s.lembaga || s.nama,
          subtitle: s.jenjang || s.deskripsi || 'Sekolah Formal',
          icon: 'fa-school',
          gradient: r[n % r.length]
        }))
      })
      function $t(e) {
        ;((S.value = e), (y.value = 'santri'), (z.value = ''), (q.value = ''), (D.value = ''))
      }
      function se(e) {
        ;((z.value = String(e.id)), (y.value = 'detail'))
      }
      function ne() {
        ;((y.value = 'santri'), (z.value = ''))
      }
      async function oe() {
        var e, t
        if (b.value)
          try {
            ...
            ;(t = L == null ? void 0 : L.error) == null ||
              t.call(L, 'Gagal cetak: ' + (r.message || r))
          }
      }
      return (
        Dt(() => {
          var t, r
          const e = String(zt.query.kategori || '').toLowerCase()
          if ((e === 'qiraati' || e === 'diniyah') && Y.value) {
            f.value = e
            const s = String(((t = N.sesiAktif) == null ? void 0 : t.lembaga) || '').trim()
            if (e === 'qiraati') {
              const n = X.find((l) => l.id.toLowerCase() === s.toLowerCase())
              n ? ((S.value = n.id), (y.value = 'detail')) : (y.value = 'lembaga')
            } else ((S.value = 'Diniyah'), (y.value = 'detail'))
          }
          if (it.value && y.value === 'picker') {
            const s = String(((r = N.sesiAktif) == null ? void 0 : r.lembaga) || '').trim(),
              n = X.find((l) => l.id.toLowerCase() === s.toLowerCase())
            n
              ? ((f.value = 'qiraati'), (S.value = n.id), (y.value = 'santri'))
              : s && ((f.value = 'diniyah'), (S.value = s), (y.value = 'santri'))
          }
        }),
        (e, t) => {
          var r, s, n
                    ...
                    a('div', ye, [
                        ...
                        a(
                          ...
                          [
                            ...
                            o(
                              ...
                              x(
                                Et.value,
                                (l) => (i(), o('option', { key: l, value: l }, d(l), 9, we))
                              ),
                              128
                            ))
                          ],
                      ...
                      Q(
                        a(
                          'select',
                          {
                            'onUpdate:modelValue': t[1] || (t[1] = (l) => (j.value = l)),
                            class:
                              'px-4 py-3 text-sm font-bold border border-slate-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-900 text-slate-800 dark:text-white'
                          },
                          [
                    ...
                    o('div', Le, [
                      a('div', Ae, [
                        a(
                          'button',
                          {
                            onClick: t[4] || (t[4] = (l) => (y.value = 'picker')),
                            class:
                          ...
                          [
                            ...(t[10] ||
                              (t[10] = [a('i', { class: 'fas fa-arrow-left' }, null, -1)]))
                          ]
                        ),
                        a('div', null, [
                          a('h2', Ke, [
                            ...
                            w(' Rapor ' + d(f.value === 'qiraati' ? 'Qiraati' : 'Diniyah'), 1)
                          ]),
                          a(
                            'p',
                            Te,
                            ' Pilih ' +
                              d(f.value === 'qiraati' ? 'lembaga Qiraati' : 'sekolah formal') +
                              '. ',
                            1
                          )
                        ])
                          ...
                          a('div', Fe, [
                            a('div', Je, [
                              a(
                                'button',
                                {
                                  onClick: t[5] || (t[5] = (l) => (y.value = 'lembaga')),
                                  class:
                                ...
                                [
                                  ...(t[12] ||
                                    (t[12] = [a('i', { class: 'fas fa-arrow-left' }, null, -1)]))
                                ]
                              ),
                              a('h2', Me, [
                                a(
                                ...
                                w(' ' + d(S.value) + ' · ' + d($.value) + ' ' + d(j.value), 1)
                              ])
                            ]),
                            a('span', Ue, d(Z.value.length) + ' santri', 1)
                          ]),
                          a('div', He, [
                            Q(
                              a(
                                'input',
                                {
                                  'onUpdate:modelValue': t[6] || (t[6] = (l) => (q.value = l)),
                                  type: 'search',
                            ...
                            Q(
                              a(
                                'select',
                                {
                                  'onUpdate:modelValue': t[7] || (t[7] = (l) => (D.value = l)),
                                  class:
                                ...
                                [
                                  t[13] || (t[13] = a('option', { value: '' }, 'Semua Kelas', -1)),
                                  (i(!0),
                                  o(
                                    g,
                                    null,
                                    x(
                                      ...
                                      (l) => (
                                        i(),
                                        o('option', { key: l, value: l }, 'Kelas ' + d(l), 9, Ge)
                                      )
                                    ),
                                    128
                                  ))
                        ...
                        Z.value.length === 0
                          ? (i(),
                            o('div', Qe, [
                              ...
                              a('p', Ve, 'Belum ada santri di ' + d(S.value), 1),
                              a(
                                'p',
                                Oe,
                                ...
                                x(
                                  ...
                                  (l) => (
                                    ...
                                    o(
                                      ...
                                      [
                                        a('div', Xe, d((l.nama || '?').charAt(0).toUpperCase()), 1),
                                        a('div', Ze, [
                                          a('p', ta, [
                                            w(d(l.nama) + ' ', 1),
                                            nt(B)(l).length > 1
                                          ...
                                          a('p', aa, [
                                            a('span', la, d(l.lembaga || '-'), 1),
                                            w(' · Kelas ' + d(l.kelas || '-') + ' ', 1),
                                            l.nis
                                              ? (i(), o('span', ra, '· NIS ' + d(l.nis), 1))
                                              : _('', !0),
                                            l.is_mukim ? (i(), o('span', sa, '· MUKIM')) : _('', !0)
                                          ])
                                        ]),
                                        t[16] ||
                                          (t[16] = a(
                            ...
                            a('div', ia, [
                              a('div', da, [
                                a(
                                  ...
                                  [
                                    ...(t[17] ||
                                      (t[17] = [a('i', { class: 'fas fa-arrow-left' }, null, -1)]))
                                  ]
                                ),
                                a('h2', ua, [
                                  a(
                                  ...
                                  w(
                                    ' ' +
                                      d((r = b.value) == null ? void 0 : r.nama) +
                                      ' · ' +
                                      d(S.value) +
                                      ' · ' +
                                      d($.value) +
                                ...
                                a('div', ka, [
                                  a('table', ha, [
                                    a('tr', null, [
                                      ...
                                      a('td', xa, [
                                        I.value.line1
                                          ? (i(), o('div', _a, d(I.value.line1), 1))
                                          : _('', !0),
                                        I.value.line2
                                          ? (i(), o('div', ya, d(I.value.line2), 1))
                                          : _('', !0),
                                        I.value.line3
                                          ? (i(), o('div', wa, d(bt(I.value.line3)), 1))
                                          : _('', !0),
                                        I.value.line4
                                          ? (i(), o('div', Sa, d(bt(I.value.line4)), 1))
                                          : _('', !0)
                                      ]),
                                      a('td', La, [
                                        pt.value
                                      ...
                                      ? (i(),
                                        o('tbody', Ia, [
                                          a('tr', null, [
                                            ...
                                            t[22] ||
                                              (t[22] = a('td', { class: 'w-[10px]' }, ':', -1)),
                                            a('td', Pa, d(b.value.nis || '-'), 1),
                                            t[23] ||
                                              (t[23] = a(
                                                'td',
                                                { class: 'w-[120px]' },
                                            ...
                                            t[24] ||
                                              (t[24] = a('td', { class: 'w-[10px]' }, ':', -1)),
                                            a('td', null, d(b.value.kelas_sekolah || '-'), 1)
                                          ]),
                                          a('tr', null, [
                                            t[25] ||
                                              (t[25] = a('td', { class: 'py-0.5' }, 'Nama', -1)),
                                            t[26] || (t[26] = a('td', null, ':', -1)),
                                            a('td', Ca, d(b.value.nama), 1),
                                            t[27] || (t[27] = a('td', null, 'Semester', -1)),
                                            t[28] || (t[28] = a('td', null, ':', -1)),
                                            a('td', null, d(j.value), 1)
                                          ]),
                                          a('tr', null, [
                                            t[29] ||
                                              (t[29] = a('td', { class: 'py-0.5' }, 'Lembaga', -1)),
                                      ...
                                      : (i(),
                                        o('tbody', $a, [
                                          a('tr', null, [
                                            ...
                                            t[32] ||
                                              (t[32] = a('td', { class: 'w-[10px]' }, ':', -1)),
                                            a('td', ja, d(b.value.nama), 1),
                                            t[33] ||
                                              (t[33] = a(
                                                'td',
                                                { class: 'w-[120px]' },
                                            ...
                                            t[34] ||
                                              (t[34] = a('td', { class: 'w-[10px]' }, ':', -1)),
                                            a('td', null, d($.value), 1)
                                          ]),
                                          a('tr', null, [
                                            t[35] ||
                                              (t[35] = a('td', { class: 'py-0.5' }, 'Lembaga', -1)),
                                            t[36] || (t[36] = a('td', null, ':', -1)),
                                            a('td', Da, d(b.value.lembaga || '-'), 1),
                                            t[37] || (t[37] = a('td', null, 'Semester', -1)),
                                            t[38] || (t[38] = a('td', null, ':', -1)),
                                            a('td', null, d(j.value), 1)
                                          ]),
                                          a('tr', null, [
                                            t[39] ||
                                              (t[39] = a('td', { class: 'py-0.5' }, 'Kelas', -1)),
                                  ...
                                  a('table', Il, [
                                    a('tr', null, [
                                      ...
                                      a('td', Pl, d(Number(Qt.value).toFixed(2)), 1)
                                    ])
                                  ]),
                                  a('table', Cl, [
                                    a('tr', null, [
                                      a('td', Nl, [
                                        ...
                                        a('p', $l, '1. Sakit : ' + d(tt.value.sakit || 0), 1),
                                        a('p', jl, '2. Izin : ' + d(tt.value.izin || 0), 1),
                                        a('p', Dl, '3. Alpa : ' + d(tt.value.alpa || 0), 1)
                                      ]),
                                      a('td', ql, [
                                        t[55] ||
                                          (t[55] = a(
                                  ...
                                  a('div', Jl, [
                                    a('table', Ml, [
                                      a('tr', null, [
                                        t[57] || (t[57] = a('td', { class: 'w-1/3' }, null, -1)),
                                        t[58] || (t[58] = a('td', { class: 'w-1/3' }, null, -1)),
                                        a('td', Ul, 'Sidoarjo, ' + d(Jt.value), 1)
                                      ]),
                                      a('tr', null, [
                                        t[59] || (t[59] = a('td', null, 'Wali Santri', -1)),
                                        t[60] || (t[60] = a('td', null, 'Guru Kelas', -1)),
                                        a('td', null, d(re.value), 1)
                                      ]),
                                      a('tr', Hl, [
                                        t[61] || (t[61] = a('td', null, null, -1)),
                                        a('td', null, [
                                          ct.value
                                            ? (i(),
                                              o(
                                      ...
                                      a('tr', Yl, [
                                        t[62] || (t[62] = a('td', null, null, -1)),
                                        a('td', null, d(It.value ? 'EKGQ: ' + It.value : ''), 1),
                                        a('td', null, d(Pt.value ? 'EKGQ: ' + Pt.value : ''), 1)
                                      ])
                                    ])
                                  ])
                                ])
  ...
  or = ve(Xl, [['__scopeId', 'data-v-533d7e90']])
