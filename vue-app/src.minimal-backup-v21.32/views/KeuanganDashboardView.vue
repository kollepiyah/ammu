  ...
  <div class="p-3 md:p-5 max-w-6xl mx-auto space-y-4">
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-4 md:grid-cols-7 gap-2 md:gap-3">
        <router-link
          to="/pos-santri"
          class="group relative overflow-hidden bg-gradient-to-br from-rose-500 to-rose-700 rounded-xl p-2.5 md:p-3 text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all flex flex-col items-center justify-center gap-1 text-center"
        >
        ...
        <router-link
          to="/tabungan"
          class="group relative overflow-hidden bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-xl p-2.5 md:p-3 text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all flex flex-col items-center justify-center gap-1 text-center"
        >
        ...
        <router-link
          to="/bisyaroh"
          class="group relative overflow-hidden bg-gradient-to-br from-amber-500 to-amber-700 rounded-xl p-2.5 md:p-3 text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all flex flex-col items-center justify-center gap-1 text-center"
        >
        ...
        <router-link
          to="/buku-induk"
          class="group relative overflow-hidden bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-xl p-2.5 md:p-3 text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all flex flex-col items-center justify-center gap-1 text-center"
        >
        ...
        <router-link
          to="/laporan-keuangan"
          class="group relative overflow-hidden bg-gradient-to-br from-purple-500 to-purple-700 rounded-xl p-2.5 md:p-3 text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all flex flex-col items-center justify-center gap-1 text-center"
        >
        ...
        <router-link
          to="/hutang-piutang"
          class="group relative overflow-hidden bg-gradient-to-br from-pink-500 to-rose-700 rounded-xl p-2.5 md:p-3 text-white shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all flex flex-col items-center justify-center gap-1 text-center"
        >
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        <router-link
          to="/tagihan"
          class="block bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition"
        >
        ...
        >
          ...
          <p class="text-[11px] text-slate-500 mt-1 font-bold">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <h3
            class="text-sm font-black text-slate-700 dark:text-slate-300 uppercase tracking-wide mb-2"
          >
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
          ...
          <div class="space-y-1.5">
            <div v-for="(k, i) in kategoriBulanIni" :key="k.nama" class="flex items-center gap-2">
              ...
              ></span>
              <p class="text-xs font-bold text-slate-700 dark:text-slate-200 flex-1 truncate">
                {{ k.nama }}
              </p>
