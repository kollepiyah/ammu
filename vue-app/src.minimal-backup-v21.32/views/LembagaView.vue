      ...
      <div v-else class="space-y-5">
        ...
        >
          ...
          <div v-if="grp.isUmbrella" class="flex items-center justify-between mb-3 px-2">
            ...
            <span
              class="text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300"
              >{{ grp.badge }}</span
            >
          </div>
          <!-- Grid sub-lembaga -->
          ...
          >
            ...
            >
              <span
                class="absolute top-3 right-3 text-[9px] px-2 py-0.5 rounded-full font-black uppercase tracking-wider bg-white/25 text-white backdrop-blur-sm"
              >
                {{ tipeLabel(l) }}
              </span>
              <div
              ...
              <span
                v-if="l.group"
                class="inline-block text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full bg-white/20 text-white mb-1.5 mt-2"
              >
                {{
                  l.tpq_group ||
                  l.tk_group ||
