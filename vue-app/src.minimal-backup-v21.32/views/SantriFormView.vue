    ...
    <form v-else @submit.prevent="onSubmit" class="space-y-4">
      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <div>
            ...
            <input
              ...
              type="date"
              required
              class="w-full px-3 py-2 text-sm rounded-xl border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 focus:ring-2 focus:ring-teal-500 outline-none cursor-pointer"
            />
          </div>
          <div>
            ...
            <input
              ...
              type="text"
              readonly
              class="w-full px-3 py-2 text-sm rounded-xl border border-slate-200 bg-slate-100 text-slate-500 font-bold"
            />
          </div>
          <div>
            <label class="block text-xs font-bold text-slate-500 mb-1 uppercase"
          ...
          <div>
            ...
            <select
              ...
              class="w-full px-3 py-2 text-sm rounded-xl border border-purple-300 bg-purple-50 cursor-pointer focus:ring-2 focus:ring-purple-500 outline-none"
            >
        ...
        <div v-if="form.is_mukim" class="mt-3">
          <label class="block text-xs font-bold text-purple-700 mb-1 uppercase">
            ...
            <span class="text-[9px] text-slate-400 normal-case">(opsional)</span>
          </label>
          <textarea
            v-model="form.catatan_riwayat_pribadi"
            rows="2"
            placeholder="Cth: latar belakang keluarga, kesehatan khusus, kebiasaan, dll."
            class="w-full px-3 py-2 text-sm rounded-xl border border-purple-300 bg-purple-50/30 focus:ring-2 focus:ring-purple-500 outline-none resize-none"
          ></textarea>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div>
            ...
            <select
              ...
              class="w-full px-3 py-2 text-sm rounded-xl border border-slate-300 bg-slate-50 cursor-pointer focus:ring-2 focus:ring-cyan-500 outline-none"
            >
          ...
          <div>
            ...
            <select
              ...
              class="w-full px-3 py-2 text-sm rounded-xl border border-slate-300 bg-slate-50 cursor-pointer disabled:opacity-50 focus:ring-2 focus:ring-cyan-500 outline-none"
            >
      ...
      >
        ...
        <div class="mt-3">
          <label class="block text-xs font-black text-teal-700 mb-1 uppercase"
            >Guru Pengajar *
            <span class="text-[9px] text-slate-400 normal-case">(max 2 guru + shift)</span></label
          >
      ...
      >
        ...
        <button
          type="submit"
          :disabled="isSaving"
          class="flex-1 px-4 py-3 bg-teal-600 hover:bg-teal-700 disabled:opacity-50 text-white font-bold transition"
        >
