  ...
  <div class="space-y-4">
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div
          class="bg-purple-50 dark:bg-purple-900/20 p-5 rounded-2xl border border-purple-100 md:col-span-2"
        >
          <h3
      ...
      <p class="text-[10px] text-slate-400 italic mt-4 text-center">
        <i class="fas fa-info-circle mr-1"></i>Untuk mengubah foto, sandi, atau no WA, klik avatar
        di kanan atas → Edit Profil.
      </p>
    </div>
