...
<template>
  ...
  >
    <div
      class="bg-[var(--bg-card)] rounded-2xl shadow-xl w-full max-w-lg max-h-[92vh] flex flex-col overflow-hidden"
    >
      <!-- header -->
      <div
        class="flex items-center justify-between px-4 py-3 border-b border-[var(--border-default)]"
      >
      ...
      <div class="flex-1 overflow-y-auto p-3 md:p-4 bg-slate-100 dark:bg-slate-800/50">
        <div
          v-if="bodyHtml"
          class="receipt-paper rounded-lg overflow-hidden shadow-sm"
          v-html="bodyHtml"
        ></div>
      ...
      <div
        class="flex items-center justify-end gap-2 px-4 py-3 border-t border-[var(--border-default)]"
      >
        <button
