<template>
  ...
  <div class="space-y-4">
    ...
    >
      <div class="bg-slate-100 dark:bg-slate-700 px-4 py-2 flex items-center justify-between">
        <p class="text-xs md:text-sm font-black text-slate-700 dark:text-slate-200">
          <i class="fas fa-folder-open mr-1"></i>Pengaturan Kartu — {{ kk.editorLembaga.value }}
        </p>
        <button
          @click="kk.tutupEditor()"
          class="text-xs text-slate-500 hover:text-slate-700 dark:text-slate-400 cursor-pointer"
        >
        ...
        >
          <div class="flex items-center justify-between flex-wrap gap-2">
            ...
            <div class="flex gap-1">
              <button
                ...
                class="text-[10px] font-bold px-2 py-1 rounded bg-amber-100 hover:bg-amber-200 text-amber-800 cursor-pointer"
              >
          ...
          <div>
            ...
            <input
              ...
              placeholder="Item"
              class="w-full px-2 py-1.5 text-sm border border-purple-300 dark:border-purple-700 rounded bg-white dark:bg-slate-900 text-slate-800 dark:text-white"
            />
          </div>
          ...
          <div class="space-y-2">
            <div class="flex items-center justify-between">
              ...
              <button
                @click="kk.addKelas()"
                class="text-[10px] bg-purple-200 hover:bg-purple-300 text-purple-800 font-bold px-2 py-0.5 rounded cursor-pointer"
              >
            ...
            >
              ...
              <div class="grid grid-cols-[1fr_auto_auto] gap-2 items-center">
                <input
                  ...
                  class="text-xs font-bold px-2 py-1 border border-slate-300 dark:border-slate-600 rounded bg-white dark:bg-slate-900 text-slate-800 dark:text-white"
                />
                <label
              ...
              <div class="space-y-1 pl-3 border-l-2 border-purple-200 dark:border-purple-700">
                ...
                <div class="flex flex-wrap gap-1">
                  <span
                    ...
                    :key="item.id"
                    class="bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-700 px-2 py-0.5 rounded text-[11px] flex items-center gap-1"
                  >
                    <input
                      v-model="item.label"
                  ...
                  <button
                    @click="kk.addItem(ki)"
                    class="bg-purple-200 hover:bg-purple-300 text-purple-800 text-[10px] font-bold px-2 py-0.5 rounded cursor-pointer"
                  >
                    + Item
                  </button>
                </div>
    ...
    <div v-else class="text-center text-slate-400 dark:text-slate-500 italic text-sm py-8">
