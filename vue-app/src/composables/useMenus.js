...
const ALL_MENUS = [
  ...
  // v.110: Dashboard Statistik kini juga memuat Laporan/Analitik (tab Santri/Keuangan/dst) — menu Laporan terpisah dihapus.
  {
    group: 'Menu',
