<template>
  <div class="p-3 md:p-5 max-w-5xl mx-auto space-y-4">
    ...
    <div
      class="bg-[var(--bg-card)] rounded-2xl p-3 border border-[var(--border-subtle)] shadow-sm grid grid-cols-2 gap-2"
    >
      <select
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
      ...
      <div
        :class="[
          ...
          saldoBersih >= 0 ? 'bg-cyan-50 border-cyan-200' : 'bg-cyan-50 border-cyan-200'
        ]"
      >
        <p
          class="text-[10px] uppercase font-black"
          :class="saldoBersih >= 0 ? 'text-cyan-700' : 'text-cyan-700'"
        >
          Saldo Bersih
        </p>
        <p
          class="text-2xl font-black mt-1"
          :class="saldoBersih >= 0 ? 'text-cyan-800' : 'text-cyan-800'"
        >
          {{ fmtRp(saldoBersih) }}
        </p>
        <p class="text-[10px] mt-1" :class="saldoBersih >= 0 ? 'text-cyan-600' : 'text-cyan-600'">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
      ...
      >
        ...
        <div class="space-y-1 text-xs">
          ...
          <div class="flex justify-between text-[10px] text-[var(--text-tertiary)] italic">
            <span>Setor tabungan</span><span>tidak dihitung</span>
          </div>
      ...
      >
        ...
        <div class="space-y-1 text-xs">
          ...
          <div class="flex justify-between text-[10px] text-[var(--text-tertiary)] italic">
            <span>Tarik tabungan</span><span>tidak dihitung</span>
          </div>
          <div class="border-t pt-1 flex justify-between font-black">
