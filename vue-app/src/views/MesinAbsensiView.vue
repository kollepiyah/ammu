    ...
    <template v-if="isElectron">
      ...
      <div class="rb-card fp-card">
        ...
        <!-- v.1.4.3 (Kyai 14 Sep 2026: "tombol2 yg digunakan untuk merapikan, jika sudah selesai
             dihapus aja"): tombol "Hapus riwayat scan" dicabut. Itu alat reset UJI COBA yang
             menghapus SELURUH absensi hasil sinkron sidik jari — dasar hitung bisyaroh — dan
             sinkron Fingerspot sudah dipakai sungguhan sejak Juli 2026. -->
