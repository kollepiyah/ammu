<template>
  <div class="p-3 md:p-5 max-w-2xl mx-auto">
    ...
    >
      ...
      <div
        v-if="!isDesktop"
        class="px-4 py-3 border-b border-[var(--border-subtle)] flex items-center justify-between gap-2"
      >
        ...
        <button
          :class="[
            ...
            activeTab === 'unread'
              ...
              : 'text-[var(--text-secondary)] hover:bg-[var(--bg-card-elevated)]'
          ]"
      ...
      <div
        ...
        class="p-12 text-center text-sm text-[var(--text-tertiary)] italic"
      >
      ...
      <div v-else class="divide-y divide-slate-100 dark:divide-slate-700">
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <p v-if="it.body" class="text-xs text-[var(--text-secondary)] line-clamp-2 mt-0.5">
              {{ it.body }}
            </p>
...
definePageActions(() => {
  ...
  if (unreadCount.value > 0)
    acts.push({ label: 'Tandai Dibaca', icon: 'check', primary: true, on: markAllRead })
