    ...
    <form v-else @submit.prevent="onSubmit" class="space-y-4">
      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <div>
            ...
            <input
              ...
              type="date"
              required
              class="w-full px-3 py-2 text-sm rounded-xl border border-[var(--border-default)] bg-[var(--bg-card-elevated)] focus:ring-2 focus:ring-teal-500 outline-none cursor-pointer"
            />
          </div>
          <div>
            <label class="block text-xs font-bold text-[var(--text-secondary)] mb-1 uppercase"
            ...
            <input
              ...
              type="text"
              readonly
              class="w-full px-3 py-2 text-sm rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-muted)] text-[var(--text-secondary)] font-bold"
            />
          </div>
          <div>
            <label class="block text-xs font-bold text-[var(--text-secondary)] mb-1 uppercase"
          ...
          <div>
            ...
            >
            <select
              v-model="statusTinggal"
              class="w-full px-3 py-2 text-sm rounded-xl border border-teal-300 bg-teal-50 cursor-pointer focus:ring-2 focus:ring-teal-500 outline-none"
            >
        ...
        <div class="mt-3">
          ...
          <textarea
            v-model="form.alamat"
            rows="2"
            class="w-full px-3 py-2 text-sm rounded-xl border border-[var(--border-default)] bg-[var(--bg-card-elevated)] focus:ring-2 focus:ring-teal-500 outline-none resize-none"
          ></textarea>
        </div>
        ...
        <div v-if="form.is_mukim" class="mt-3">
          <label class="block text-xs font-bold text-teal-700 mb-1 uppercase">
            <i class="fas fa-mosque mr-1"></i>Catatan Riwayat Pribadi (Ma'had)
            <span class="text-[9px] text-[var(--text-tertiary)] normal-case">(opsional)</span>
          </label>
          <textarea
            v-model="form.catatan_riwayat_pribadi"
            rows="2"
            class="w-full px-3 py-2 text-sm rounded-xl border border-teal-300 bg-teal-50/30 focus:ring-2 focus:ring-teal-500 outline-none resize-none"
          ></textarea>
        </div>
      </div>
      ...
      >
        <h3
          class="text-xs font-black text-slate-700 dark:text-[var(--text-tertiary)] uppercase tracking-wide mb-3"
        >
          <i class="fas fa-people-roof text-teal-500 mr-1"></i>Data Orang Tua &amp; Asal Sekolah
        </h3>
        <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
          <div class="md:col-span-5 text-[11px] font-black text-teal-700 dark:text-teal-300">
            Ayah
          </div>
          <div>
            <label class="block text-xs font-bold text-[var(--text-secondary)] mb-1 uppercase"
          ...
          <div>
            ...
            >
            <input
              v-model="form.hp_ayah"
              type="text"
              class="w-full px-3 py-2 text-sm rounded-xl border border-[var(--border-default)] bg-[var(--bg-card-elevated)] focus:ring-2 focus:ring-teal-500 outline-none"
            />
          </div>
          <div class="md:col-span-5 text-[11px] font-black text-rose-700 dark:text-rose-300">
            Ibu
          </div>
          <div>
            <label class="block text-xs font-bold text-[var(--text-secondary)] mb-1 uppercase"
          ...
          <div
            class="md:col-span-5 text-[11px] font-black text-slate-600 dark:text-[var(--text-tertiary)]"
          >
            Lainnya
          </div>
          <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div>
            ...
            <select
              ...
              class="w-full px-3 py-2 text-sm rounded-xl border border-[var(--border-default)] bg-[var(--bg-card-elevated)] cursor-pointer focus:ring-2 focus:ring-cyan-500 outline-none"
            >
          ...
          <div>
            ...
            >
            <select
              v-model="form.kelas_sekolah"
              :disabled="!form.lembaga_sekolah"
              class="w-full px-3 py-2 text-sm rounded-xl border border-[var(--border-default)] bg-[var(--bg-card-elevated)] cursor-pointer disabled:opacity-50 focus:ring-2 focus:ring-cyan-500 outline-none"
            >
      ...
      >
        <h3
          class="text-xs font-black text-teal-800 dark:text-teal-300 uppercase tracking-wide mb-3"
        >
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div>
            ...
            <select
              v-model="form.kelas"
              required
              :disabled="!form.lembaga"
              class="w-full px-3 py-2 text-sm rounded-xl border-2 border-teal-400 bg-teal-50 cursor-pointer disabled:opacity-50 focus:ring-2 focus:ring-teal-500 outline-none"
            >
              <option value="">-- Pilih --</option>
          ...
          <div v-if="form.lembaga === 'PTPT'">
            <label class="block text-xs font-bold text-rose-600 mb-1 uppercase"
              >Juz (PTPT only)</label
            >
            <input
              v-model="form.juz"
              type="text"
              class="w-full px-3 py-2 text-sm rounded-xl border-2 border-rose-300 bg-rose-50 text-rose-800 focus:ring-2 focus:ring-rose-500 outline-none"
            />
          </div>
        </div>
        ...
        <div v-if="form.aktif === false" class="mt-3 grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              type="date"
              class="w-full px-3 py-2 text-sm rounded-xl border border-rose-300 bg-rose-50/40 focus:ring-2 focus:ring-rose-500 outline-none cursor-pointer"
            />
          </div>
          <div>
            <label class="block text-xs font-bold text-rose-700 mb-1 uppercase"
            ...
            <input
              ...
              type="text"
              class="w-full px-3 py-2 text-sm rounded-xl border border-rose-300 bg-rose-50/40 focus:ring-2 focus:ring-rose-500 outline-none"
            />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <button
          type="submit"
          :disabled="isSaving"
          class="flex-1 px-4 py-3 bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] disabled:opacity-50 text-white font-bold transition"
        >
          <i class="fas fa-save mr-1"></i
          >{{ isSaving ? 'Menyimpan...' : editingId ? 'Update Santri' : 'Simpan Santri' }}
        </button>
      </div>
    </form>

    <p class="text-center text-[10px] text-[var(--text-tertiary)] pt-2">
      <i class="fas fa-circle-info mr-1"></i>v.21.13.0526
    </p>
  </div>
</template>
