      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-[var(--bg-card-elevated)] p-5 rounded-2xl border border-[var(--border-subtle)]">
          ...
          <ul class="space-y-3 text-sm">
            ...
            <li class="flex justify-between gap-2">
              <span class="text-slate-700 dark:text-[var(--text-tertiary)] font-bold">Hak Akses:</span>
        ...
        <div class="bg-emerald-50 dark:bg-emerald-900/20 p-5 rounded-2xl border border-emerald-100">
          ...
          <p class="text-[11px] text-cyan-700 italic mt-3 bg-cyan-50 dark:bg-cyan-900/20 p-2 rounded border border-cyan-100 dark:border-cyan-800">
