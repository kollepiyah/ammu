    ...
    >
      ...
      <div v-if="mode === 'view'" class="p-4 md:p-6 space-y-4">
        ...
        >
          <!-- Identitas -->
          <div
            class="snap-center shrink-0 w-[88%] md:w-auto bg-[var(--bg-card-elevated)] p-5 rounded-2xl border border-[var(--border-subtle)]"
          >
            <h3
          ...
          <!-- Tugas & Lembaga -->
          <div
            class="snap-center shrink-0 w-[88%] md:w-auto bg-cyan-50 dark:bg-cyan-900/20 p-5 rounded-2xl border border-cyan-100"
          >
            <h3
        ...
        <div class="bg-teal-50 dark:bg-teal-900/20 p-5 rounded-2xl border border-teal-100">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
            ...
            <div class="bg-[var(--bg-card)] p-3 rounded-xl border border-teal-100">
              ...
              <p class="font-black text-slate-800 dark:text-slate-100 mt-1">
                {{ guru?.nig || guru?.ekgq || guru?.no_syahadah || '-' }}
              </p>
            </div>
            <div class="bg-[var(--bg-card)] p-3 rounded-xl border border-teal-100">
      ...
      <div v-if="mode === 'edit'" class="p-4 space-y-4">
        ...
        >
          ...
          Lengkapi data profil Anda. Data jabatan, lembaga, dan akses sistem hanya bisa diubah oleh
          admin.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div>
            ...
            <input
              ...
              type="date"
              class="w-full px-3 py-2 text-sm rounded-xl border border-[var(--border-default)] bg-[var(--bg-card-elevated)] focus:ring-2 focus:ring-emerald-500 outline-none cursor-pointer"
            />
          </div>
          <div>
            <label class="block text-xs font-bold text-[var(--text-secondary)] mb-1 uppercase"
        ...
        <!-- Pendidikan -->
        <div
          class="bg-cyan-50/40 dark:bg-cyan-900/20 rounded-2xl p-4 border border-cyan-200 dark:border-cyan-800"
        >
          <h4 class="text-xs font-black text-cyan-700 dark:text-cyan-300 uppercase mb-3">
            <i class="fas fa-graduation-cap mr-1"></i>Pendidikan Terakhir
          </h4>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div>
              <label class="block text-xs font-bold text-cyan-700 mb-1 uppercase">Jenjang</label>
              <select
                v-model="editForm.pendidikan_terakhir"
                class="w-full px-3 py-2 text-sm rounded-xl border border-cyan-300 bg-white dark:bg-[var(--bg-card-elevated)] focus:ring-2 focus:ring-cyan-500 outline-none"
              >
      ...
      <p
        ...
        class="text-[10px] text-[var(--text-tertiary)] italic mt-4 text-center pb-3"
      >
        <i class="fas fa-info-circle mr-1"></i>Untuk mengubah foto/sandi → tab "Pengaturan Profil"
        di bawah. Untuk update data personal (NIK, alamat, pendidikan, dll) → klik tab "Edit Data
        Saya" di atas.
      </p>
    </div>
...
async function saveProfile() {
  ...
  try {
    ...
    await updateOne('guru', String(props.guru.id), {
      nik: ef.nik,
